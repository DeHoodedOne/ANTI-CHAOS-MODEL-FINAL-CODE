...
SPORTS = ['AMERICAN FOOTBALL.py', 'AUSSIE RULES.py',
          'BANDY.py', 'BASEBALL.py', 'BEACH SOCCER.py',
          'FUSTAL.py', 'HANDBALL.py', 'FOOTBALL.py', 'NETBALL.py']
for sport in SPORTS:
    runpy.run_path(path_name=sport)

if is_running(game_criteria()[13][1]) is False and is_running(game_criteria()[13][2]) is False:
    try:
        cleanse()
