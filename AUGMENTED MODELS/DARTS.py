...
def h2h_prob_calc():
    ...
    if prob_AW == 0:
        prob_AW += 0.01
    return [prob_HW, prob_AW, prob_4_5i, prob_5_5i, prob_6_5i, prob_sh1_1_5i, prob_sh1_2_5i, prob_sh2_1_5i, prob_sh2_2_5i, prob_12i]
...
def ht_indp_prob_calc():
    ...
    if prob_AW_H_indp == 0:
        prob_AW_H_indp += 0.01
    return [prob_HW_H_indp, prob_AW_H_indp, prob_4_5_H_indp, prob_5_5_H_indp, prob_6_5_H_indp, prob_sh1_1_5_H_indp,
...
def at_indp_prob_calc():
    ...
    if prob_AW_A_indp == 0:
        prob_AW_A_indp += 0.01
    return [prob_HW_A_indp, prob_AW_A_indp, prob_4_5_A_indp, prob_5_5_A_indp, prob_6_5_A_indp, prob_sh1_1_5_A_indp,
...
def total_aggregator():
    ...
    try:
        ...
        if len(sub1) == 0:
            ht_indp_appender(prb_HW_H_indp=0.01, prb_AW_H_indp=0.01, prb_4_5_H_indp=0.01, prb_5_5_H_indp=0.01,
                             prb_6_5_H_indp=0.01, prb_sh1_1_5_H_indp=0.01, prb_sh1_2_5_H_indp=0.01,
    ...
    try:
        ...
        if len(sub2) == 0:
            at_indp_appender(prb_HW_A_indp=0.01, prb_AW_A_indp=0.01, prb_4_5_A_indp=0.01, prb_5_5_A_indp=0.01,
                             prb_6_5_A_indp=0.01, prb_sh1_1_5_A_indp=0.01, prb_sh1_2_5_A_indp=0.01,
    ...
    try:
        ...
        if len(sub3) == 0:
            h2h_appender(prb_HW=0.01, prb_AW=0.01, prb_4_5=0.01, prb_5_5=0.01, prb_6_5=0.01, prb_sh1_1_5=0.01,
...
def print_all_data():
    ...
    print(f"Prob 5_5s: {prob_5_5s}")
    print(f"Prob 6_5s: {prob_6_5s}")
    print(f"Prob sh1_1_5_5s: {prob_sh1_1_5s}")
    print(f"Prob sh1_2_5_5s: {prob_sh1_2_5s}")
    print(f"Prob sh2_1_5_5s: {prob_sh2_1_5s}")
    print(f"Prob sh2_2_5_5s: {prob_sh2_2_5s}")
    print(f"Prob 12s: {prob_12s}")
    print(f"Prob HWs: {prob_HWs}")
    print(f"Prob AWs: {prob_AWs}")
    print(f"Prob 4_5_H_indps: {prob_4_5_H_indps}")
    print(f"Prob 5_5_H_indps: {prob_5_5_H_indps}")
    ...
    print(f"Prob 5_5_A_indps: {prob_5_5_A_indps}")
    ...
    print(f"Bayesian 5.5: {bayesian_5_5_d}")
    print(f"Bayesian 6.5: {bayesian_6_5_d}")
    ...
    for COMBINER in COMBINERS[:4]:
        ...
        for COMB in COMB_PROB_METRICS1:
            ...
            for q in range(len(bayesian_home_Win_d)):
                ...
                try:
                    if bayesian_4_5_d[q] > CONFINTVL or bayesian_5_5_d[q] > CONFINTVL or bayesian_6_5_d[q] > CONFINTVL or bayesian_sh1_1_5_d[q] > CONFINTVL or bayesian_sh1_2_5_d[q] > CONFINTVL or bayesian_sh2_1_5_d[q] > CONFINTVL or bayesian_sh2_2_5_d[q] > CONFINTVL:
                            ...
                            if h_form_D[q] == 0 and a_form_D[q] == 0:
                                if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                    if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                        ...
                                        if bayesian_6_5_d[q] <= bayesian_5_5_d[q] <= bayesian_4_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and BAY_DIFF <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= bayesian_12_d[q] and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                            with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                writer(w=q, A=X, B=Y, C=Z, data=file)
