...
OUTCOMES = ["HW", "AW", "ov15.5", "ov17.5", "ov19.5", "sh1_2.5", "sh1_3.5", "sh2_2.5", "sh2_3.5", "12"]

start_time = time.time()
SPORT_ = master_sport_list()[0][28]
...
def h2h_aggregator(m, home_score, away_score, home_x, away_x):
    ...
    global count_sh1_3_5
    global count_sh2_2_5
    global count_sh2_3_5
    global count_12
    valid_games += 1
    sleep(0.5)
    ...
    if int(home_score[m].text) == int(away_score[m].text) and (int(home_score[m].text) == 0 and int(away_score[m].text) == 0):
        count_HW += 0
        count_AW += 0
    if (int(home_score[m].text) + int(away_score[m].text)) >= 16:
        count_15_5 += 1
    if (int(home_score[m].text) + int(away_score[m].text)) >= 18:
        count_17_5 += 1
    if (int(home_score[m].text) + int(away_score[m].text)) >= 20:
        count_19_5 += 1
    ...
    if ((int(away_score[m].text) + 2.5) > int(home_score[m].text)) and (away_x[m].text == away_teamx):
        count_sh2_2_5 += 1
    if ((int(home_score[m].text) + 3.5) > int(away_score[m].text)) and (home_x[m].text == home_teamx):
        count_sh1_3_5 += 1
    if ((int(away_score[m].text) + 3.5) > int(home_score[m].text)) and (away_x[m].text == home_teamx):
        count_sh1_3_5 += 1
    if ((int(home_score[m].text) + 3.5) > int(away_score[m].text)) and (home_x[m].text == away_teamx):
        count_sh2_3_5 += 1
    if ((int(away_score[m].text) + 3.5) > int(home_score[m].text)) and (away_x[m].text == away_teamx):
        count_sh2_3_5 += 1
...
def h2h_prob_calc():
    ...
    global count_sh2_3_5
    global count_12
    prob_15_5i = float(count_15_5 / valid_games)
    prob_17_5i = float(count_17_5 / valid_games)
    prob_19_5i = float(count_19_5 / valid_games)
    prob_sh1_2_5i = float(count_sh1_2_5 / valid_games)
    prob_sh1_3_5i = float(count_sh1_3_5 / valid_games)
    prob_sh2_2_5i = float(count_sh2_2_5 / valid_games)
    prob_sh2_3_5i = float(count_sh2_3_5 / valid_games)
    ...
    if prob_sh2_2_5i == 1.0:
        prob_sh2_2_5i -= 0.01
    if prob_sh1_3_5i == 1.0:
        prob_sh1_3_5i -= 0.01
    if prob_sh2_3_5i == 1.0:
        prob_sh2_3_5i -= 0.01
    if prob_12i == 1.0:
        prob_12i -= 0.01
    ...
    if prob_AW == 0:
        prob_AW += 0.01
    return [prob_HW, prob_AW, prob_15_5i, prob_17_5i, prob_19_5i, prob_sh1_2_5i, prob_sh1_3_5i, prob_sh2_2_5i, prob_sh2_3_5i, prob_12i]


def h2h_appender(prb_HW, prb_AW, prb_15_5, prb_17_5, prb_19_5, prb_sh1_2_5, prb_sh1_3_5, prb_sh2_2_5, prb_sh2_3_5, prb_12):
    prob_HWs.append(prb_HW)
    prob_AWs.append(prb_AW)
    prob_15_5s.append(prb_15_5)
    prob_17_5s.append(prb_17_5)
    prob_19_5s.append(prb_19_5)
    prob_sh1_2_5s.append(prb_sh1_2_5)
    prob_sh1_3_5s.append(prb_sh1_3_5)
    prob_sh2_2_5s.append(prb_sh2_2_5)
    prob_sh2_3_5s.append(prb_sh2_3_5)
...
def ht_indp_aggregator(k, home_score, away_score, home_x, away_x):
    ...
    global count_15_5_H_indp
    global count_17_5_H_indp
    global count_19_5_H_indp
    global count_sh1_2_5_H_indp
    global count_sh1_3_5_H_indp
    ...
    if int(home_score[k].text) == int(away_score[k].text) and (int(home_score[k].text) == 0 and int(away_score[k].text) == 0):
        count_HW_H_indp += 0
    if (int(home_score[k].text) + int(away_score[k].text)) >= 16 and (home_x[k].text == home_teamx) and int(home_score[k].text) >= 8:
        count_15_5_H_indp += 1
    if (int(home_score[k].text) + int(away_score[k].text)) >= 16 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 8:
        count_15_5_H_indp += 1
    if (int(home_score[k].text) + int(away_score[k].text)) >= 18 and (home_x[k].text == home_teamx) and int(home_score[k].text) >= 9:
        count_17_5_H_indp += 1
    if (int(home_score[k].text) + int(away_score[k].text)) >= 18 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 9:
        count_17_5_H_indp += 1
    if (int(home_score[k].text) + int(away_score[k].text)) >= 20 and (home_x[k].text == home_teamx) and int(home_score[k].text) >= 10:
        count_19_5_H_indp += 1
    if (int(home_score[k].text) + int(away_score[k].text)) >= 20 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 10:
        count_19_5_H_indp += 1
    ...
    if ((int(away_score[k].text) + 2.5) > int(home_score[k].text)) and (away_x[k].text == home_teamx):
        count_sh1_2_5_H_indp += 1
    if ((int(home_score[k].text) + 3.5) > int(away_score[k].text)) and (home_x[k].text == home_teamx):
        count_sh1_3_5_H_indp += 1
    if ((int(away_score[k].text) + 3.5) > int(home_score[k].text)) and (away_x[k].text == home_teamx):
        count_sh1_3_5_H_indp += 1
...
def ht_indp_prob_calc():
    ...
    prob_15_5_H_indp = float(count_15_5_H_indp / valid_games_H_indp)
    prob_17_5_H_indp = float(count_17_5_H_indp / valid_games_H_indp)
    prob_19_5_H_indp = float(count_19_5_H_indp / valid_games_H_indp)
    prob_sh1_2_5_H_indp = float(count_sh1_2_5_H_indp / valid_games_H_indp)
    prob_sh1_3_5_H_indp = float(count_sh1_3_5_H_indp / valid_games_H_indp)
    prob_sh2_2_5_H_indp = 1 - prob_sh1_2_5_H_indp
    prob_sh2_3_5_H_indp = 1 - prob_sh1_3_5_H_indp
    ...
    if prob_AW_H_indp == 1.0:
        prob_AW_H_indp -= 0.01
    if prob_15_5_H_indp == 1.0:
        prob_15_5_H_indp -= 0.01
    if prob_17_5_H_indp == 1.0:
        prob_17_5_H_indp -= 0.01
    if prob_19_5_H_indp == 1.0:
        prob_19_5_H_indp -= 0.01
    if prob_sh1_2_5_H_indp == 1.0:
        prob_sh1_2_5_H_indp -= 0.01
    if prob_sh2_2_5_H_indp == 1.0:
        prob_sh2_2_5_H_indp -= 0.01
    if prob_sh1_3_5_H_indp == 1.0:
        prob_sh1_3_5_H_indp -= 0.01
    if prob_sh2_3_5_H_indp == 1.0:
        prob_sh2_3_5_H_indp -= 0.01
    if prob_12_H_indp == 1.0:
        prob_12_H_indp -= 0.01

    if prob_15_5_H_indp == 0:
        prob_15_5_H_indp += 0.01
    if prob_17_5_H_indp == 0:
        prob_17_5_H_indp += 0.01
    if prob_19_5_H_indp == 0:
        prob_19_5_H_indp += 0.01
    if prob_sh1_2_5_H_indp == 0:
        prob_sh1_2_5_H_indp += 0.01
    if prob_sh2_2_5_H_indp == 0:
        prob_sh2_2_5_H_indp += 0.01
    if prob_sh1_3_5_H_indp == 0:
        prob_sh1_3_5_H_indp += 0.01
    if prob_sh2_3_5_H_indp == 0:
        prob_sh2_3_5_H_indp += 0.01
    if prob_12_H_indp == 0:
        prob_12_H_indp += 0.01
    if prob_HW_H_indp == 0:
    ...
    if prob_AW_H_indp == 0:
        prob_AW_H_indp += 0.01
    return [prob_HW_H_indp, prob_AW_H_indp, prob_15_5_H_indp, prob_17_5_H_indp, prob_19_5_H_indp, prob_sh1_2_5_H_indp,
            prob_sh1_3_5_H_indp, prob_sh2_2_5_H_indp, prob_sh2_3_5_H_indp, prob_12_H_indp]


def ht_indp_appender(prb_HW_H_indp, prb_AW_H_indp, prb_15_5_H_indp, prb_17_5_H_indp, prb_19_5_H_indp, prb_sh1_2_5_H_indp,
                     prb_sh1_3_5_H_indp, prb_sh2_2_5_H_indp, prb_sh2_3_5_H_indp, prb_12_H_indp):
    prob_HW_H_indps.append(prb_HW_H_indp)
    prob_AW_H_indps.append(prb_AW_H_indp)
    prob_15_5_H_indps.append(prb_15_5_H_indp)
    prob_17_5_H_indps.append(prb_17_5_H_indp)
    prob_19_5_H_indps.append(prb_19_5_H_indp)
    prob_sh1_2_5_H_indps.append(prb_sh1_2_5_H_indp)
    prob_sh1_3_5_H_indps.append(prb_sh1_3_5_H_indp)
    prob_sh2_2_5_H_indps.append(prb_sh2_2_5_H_indp)
    prob_sh2_3_5_H_indps.append(prb_sh2_3_5_H_indp)
...
def at_indp_aggregator(n, home_score, away_score, home_x, away_x):
    ...
    global count_15_5_A_indp
    global count_17_5_A_indp
    global count_19_5_A_indp
    global count_sh2_2_5_A_indp
    global count_sh2_3_5_A_indp
    ...
    if int(home_score[n].text) == int(away_score[n].text) and (int(home_score[n].text) == 0 and int(away_score[n].text) == 0):
        count_AW_A_indp += 0
    if (int(home_score[n].text) + int(away_score[n].text)) >= 16 and (home_x[n].text == away_teamx) and int(home_score[n].text) >= 8:
        count_15_5_A_indp += 1
    if (int(home_score[n].text) + int(away_score[n].text)) >= 16 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 8:
        count_15_5_A_indp += 1
    if (int(home_score[n].text) + int(away_score[n].text)) >= 18 and (home_x[n].text == away_teamx) and int(home_score[n].text) >= 9:
        count_17_5_A_indp += 1
    if (int(home_score[n].text) + int(away_score[n].text)) >= 18 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 9:
        count_17_5_A_indp += 1
    if (int(home_score[n].text) + int(away_score[n].text)) >= 20 and (home_x[n].text == away_teamx) and int(home_score[n].text) >= 10:
        count_19_5_A_indp += 1
    if (int(home_score[n].text) + int(away_score[n].text)) >= 20 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 10:
        count_19_5_A_indp += 1
    ...
    if ((int(away_score[n].text) + 2.5) > int(home_score[n].text)) and (away_x[n].text == away_teamx):
        count_sh2_2_5_A_indp += 1
    if ((int(home_score[n].text) + 3.5) > int(away_score[n].text)) and (home_x[n].text == away_teamx):
        count_sh2_3_5_A_indp += 1
    if ((int(away_score[n].text) + 3.5) > int(home_score[n].text)) and (away_x[n].text == away_teamx):
        count_sh2_3_5_A_indp += 1
...
def at_indp_prob_calc():
    ...
    prob_15_5_A_indp = float(count_15_5_A_indp / valid_games_A_indp)
    prob_17_5_A_indp = float(count_17_5_A_indp / valid_games_A_indp)
    prob_19_5_A_indp = float(count_19_5_A_indp / valid_games_A_indp)
    prob_sh2_2_5_A_indp = float(count_sh2_2_5_A_indp / valid_games_A_indp)
    prob_sh2_3_5_A_indp = float(count_sh2_3_5_A_indp / valid_games_A_indp)
    prob_sh1_2_5_A_indp = 1 - prob_sh2_2_5_A_indp
    prob_sh1_3_5_A_indp = 1 - prob_sh2_3_5_A_indp
    ...
    if prob_AW_A_indp == 1.0:
        prob_AW_A_indp -= 0.01
    if prob_15_5_A_indp == 1.0:
        prob_15_5_A_indp -= 0.01
    if prob_17_5_A_indp == 1.0:
        prob_17_5_A_indp -= 0.01
    if prob_19_5_A_indp == 1.0:
        prob_19_5_A_indp -= 0.01
    if prob_sh1_2_5_A_indp == 1.0:
        prob_sh1_2_5_A_indp -= 0.01
    if prob_sh2_2_5_A_indp == 1.0:
        prob_sh2_2_5_A_indp -= 0.01
    if prob_sh1_3_5_A_indp == 1.0:
        prob_sh1_3_5_A_indp -= 0.01
    if prob_sh2_3_5_A_indp == 1.0:
        prob_sh2_3_5_A_indp -= 0.01
    if prob_12_A_indp == 1.0:
        prob_12_A_indp -= 0.01

    if prob_15_5_A_indp == 0:
        prob_15_5_A_indp += 0.01
    if prob_17_5_A_indp == 0:
        prob_17_5_A_indp += 0.01
    if prob_19_5_A_indp == 0:
        prob_19_5_A_indp += 0.01
    if prob_sh1_2_5_A_indp == 0:
        prob_sh1_2_5_A_indp += 0.01
    if prob_sh2_2_5_A_indp == 0:
        prob_sh2_2_5_A_indp += 0.01
    if prob_sh1_3_5_A_indp == 0:
        prob_sh1_3_5_A_indp += 0.01
    if prob_sh2_3_5_A_indp == 0:
        prob_sh2_3_5_A_indp += 0.01
    if prob_12_A_indp == 0:
        prob_12_A_indp += 0.01
    if prob_HW_A_indp == 0:
    ...
    if prob_AW_A_indp == 0:
        prob_AW_A_indp += 0.01
    return [prob_HW_A_indp, prob_AW_A_indp, prob_15_5_A_indp, prob_17_5_A_indp, prob_19_5_A_indp, prob_sh1_2_5_A_indp,
            prob_sh1_3_5_A_indp, prob_sh2_2_5_A_indp, prob_sh2_3_5_A_indp, prob_12_A_indp]


def at_indp_appender(prb_HW_A_indp, prb_AW_A_indp, prb_15_5_A_indp, prb_17_5_A_indp, prb_19_5_A_indp, prb_sh1_2_5_A_indp,
                     prb_sh1_3_5_A_indp, prb_sh2_2_5_A_indp, prb_sh2_3_5_A_indp, prb_12_A_indp):
    prob_HW_A_indps.append(prb_HW_A_indp)
    prob_AW_A_indps.append(prb_AW_A_indp)
    prob_15_5_A_indps.append(prb_15_5_A_indp)
    prob_17_5_A_indps.append(prb_17_5_A_indp)
    prob_19_5_A_indps.append(prb_19_5_A_indp)
    prob_sh1_2_5_A_indps.append(prb_sh1_2_5_A_indp)
    prob_sh1_3_5_A_indps.append(prb_sh1_3_5_A_indp)
    prob_sh2_2_5_A_indps.append(prb_sh2_2_5_A_indp)
    prob_sh2_3_5_A_indps.append(prb_sh2_3_5_A_indp)
...
def odds_checker():
    try:
        ...
        try:
            ...
            for y in range(len(ahl)):
                try:
                    id_sh_3_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({y + 1}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_sh_3_5 == "+3.5":
                        OVER_sh1_3_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({y + 1}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
                        OVER_sh1_3_5_S.append(1 / float(OVER_sh1_3_5))
                        OVER_sh2_3_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({y + 1}) .ui-table__row:nth-child(1) .oddsCell__odd')[1].text.strip()
                        OVER_sh2_3_5_S.append(1 / float(OVER_sh2_3_5))
                        break
                    if y == (len(ahl) - 1):
                        OVER_sh1_3_5_S.append(0.5)
                        OVER_sh2_3_5_S.append(0.5)
                except NoSuchElementException:
                    continue
                except IndexError:
                    OVER_sh1_3_5_S.append(0.5)
        ...
        try:
            ...
            for x in range(len(ahl)):
                try:
                    id_15_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_15_5 == "15.5":
                        OVER_15_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
                        OVER_15_5_S.append(1 / float(OVER_15_5))
                        break
                    if x == (len(ahl) - 1):
                        OVER_15_5_S.append(0.5)
                except NoSuchElementException:
                    continue
                except IndexError:
                    OVER_15_5_S.append(0.5)
            for x in range(len(ahl)):
                try:
                    id_17_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_17_5 == "17.5":
                        OVER_17_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
                        OVER_17_5_S.append(1 / float(OVER_17_5))
                        break
                    if x == (len(ahl) - 1):
                        OVER_17_5_S.append(0.5)
                except NoSuchElementException:
                    continue
                except IndexError:
                    OVER_17_5_S.append(0.5)
            for z in range(len(ahl)):
                try:
                    id_19_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({z}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_19_5 == "19.5":
                        OVER_19_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({z}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
                        OVER_19_5_S.append(1 / float(OVER_19_5))
                        break
                    if z == (len(ahl) - 1):
                        OVER_19_5_S.append(0.5)
                except NoSuchElementException:
                    continue
                except IndexError:
                    OVER_19_5_S.append(0.5)
...
def writer(w, A, B, C, data):
    data.write(f"{countries[w]}|{leagues[w]}|{home_teams[w]}|{away_teams[w]}|{home_positions[w]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_15_5_d[w]}|{OUTCOMES[3]}:-{bayesian_17_5_d[w]}|"
               f"{OUTCOMES[4]}:-{bayesian_19_5_d[w]}|{OUTCOMES[5]}:-{bayesian_sh1_2_5_d[w]}|{OUTCOMES[6]}:-{bayesian_sh1_3_5_d[w]}|"
               f"{OUTCOMES[7]}:-{bayesian_sh2_2_5_d[w]}|{OUTCOMES[8]}:-{bayesian_sh2_3_5_d[w]}|{OUTCOMES[9]}:-{bayesian_12_d[w]}|"
...
def writer1(y, F, G, H, J, data):
    data.write(f"{countries[y]}|{leagues[y]}|{home_teams[y]}|{away_teams[y]}|{home_positions[y]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_15_5_d[y]}|{OUTCOMES[3]}:-{bayesian_17_5_d[y]}|"
               f"{OUTCOMES[4]}:-{bayesian_19_5_d[y]}|{OUTCOMES[5]}:-{bayesian_sh1_2_5_d[y]}|{OUTCOMES[6]}:-{bayesian_sh1_3_5_d[y]}|"
               f"{OUTCOMES[7]}:-{bayesian_sh2_2_5_d[y]}|{OUTCOMES[8]}:-{bayesian_sh2_3_5_d[y]}|{OUTCOMES[9]}:-{bayesian_12_d[y]}|"
...
def writer2(z, K, L, M, N, P, data):
    data.write(f"{countries[z]}|{leagues[z]}|{home_teams[z]}|{away_teams[z]}|{home_positions[z]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_15_5_d[z]}|{OUTCOMES[3]}:-{bayesian_17_5_d[z]}|"
               f"{OUTCOMES[4]}:-{bayesian_19_5_d[z]}|{OUTCOMES[5]}:-{bayesian_sh1_2_5_d[z]}|{OUTCOMES[6]}:-{bayesian_sh1_3_5_d[z]}|"
               f"{OUTCOMES[7]}:-{bayesian_sh2_2_5_d[z]}|{OUTCOMES[8]}:-{bayesian_sh2_3_5_d[z]}|{OUTCOMES[9]}:-{bayesian_12_d[z]}|"
               f"{match_times[z]}|{sport}|{P}_{K}_{L}_{M}_{N}|{set_date_s_size()[0]}\n")


def baye_appender(baye_HW, baye_AW, baye_15_5, baye_17_5, baye_19_5, baye_sh1_2_5, baye_sh1_3_5, baye_sh2_2_5,
                  baye_sh2_3_5, baye_12):
    bayesian_home_Win_d.append(round((float(baye_HW)), 4))
    bayesian_away_Win_d.append(round((float(baye_AW)), 4))
    bayesian_15_5_d.append(round((float(baye_15_5)), 4))
    bayesian_17_5_d.append(round((float(baye_17_5)), 4))
    bayesian_19_5_d.append(round((float(baye_19_5)), 4))
    bayesian_sh1_2_5_d.append(round((float(baye_sh1_2_5)), 4))
    bayesian_sh1_3_5_d.append(round((float(baye_sh1_3_5)), 4))
    bayesian_sh2_2_5_d.append(round((float(baye_sh2_2_5)), 4))
    bayesian_sh2_3_5_d.append(round((float(baye_sh2_3_5)), 4))
...
def total_aggregator():
    ...
    try:
        ...
        if len(sub1) == 0:
            ht_indp_appender(prb_HW_H_indp=0.01, prb_AW_H_indp=0.01, prb_15_5_H_indp=0.01, prb_17_5_H_indp=0.01,
                             prb_19_5_H_indp=0.01, prb_sh1_2_5_H_indp=0.01, prb_sh1_3_5_H_indp=0.01,
                             prb_sh2_2_5_H_indp=0.01, prb_sh2_3_5_H_indp=0.01, prb_12_H_indp=0.01)
            ht_scores = []
            ...
            if dsc >= DSCRM_H_A:
                try:
                    ...
                    ht_indp_appender(prb_HW_H_indp=ht_indp_values[0], prb_AW_H_indp=ht_indp_values[1],
                                     prb_15_5_H_indp=ht_indp_values[2], prb_17_5_H_indp=ht_indp_values[3],
                                     prb_19_5_H_indp=ht_indp_values[4], prb_sh1_2_5_H_indp=ht_indp_values[5],
                                     prb_sh1_3_5_H_indp=ht_indp_values[6], prb_sh2_2_5_H_indp=ht_indp_values[7],
                                     prb_sh2_3_5_H_indp=ht_indp_values[8], prb_12_H_indp=ht_indp_values[9])
                except ZeroDivisionError:
                    ht_indp_appender(prb_HW_H_indp=0.01, prb_AW_H_indp=0.01, prb_15_5_H_indp=0.01, prb_17_5_H_indp=0.01,
                                     prb_19_5_H_indp=0.01, prb_sh1_2_5_H_indp=0.01, prb_sh1_3_5_H_indp=0.01,
                                     prb_sh2_2_5_H_indp=0.01, prb_sh2_3_5_H_indp=0.01, prb_12_H_indp=0.01)
    ...
    try:
        ...
        if len(sub2) == 0:
            at_indp_appender(prb_HW_A_indp=0.01, prb_AW_A_indp=0.01, prb_15_5_A_indp=0.01, prb_17_5_A_indp=0.01,
                             prb_19_5_A_indp=0.01, prb_sh1_2_5_A_indp=0.01, prb_sh1_3_5_A_indp=0.01,
                             prb_sh2_2_5_A_indp=0.01, prb_sh2_3_5_A_indp=0.01, prb_12_A_indp=0.01)
            at_scores = []
            for r in range(DSCRM_H_A):
            ...
            if dsc >= DSCRM_H_A:
                try:
                    ...
                    at_indp_appender(prb_HW_A_indp=at_indp_values[0], prb_AW_A_indp=at_indp_values[1],
                                     prb_15_5_A_indp=at_indp_values[2], prb_17_5_A_indp=at_indp_values[3],
                                     prb_19_5_A_indp=at_indp_values[4], prb_sh1_2_5_A_indp=at_indp_values[5],
                                     prb_sh1_3_5_A_indp=at_indp_values[6], prb_sh2_2_5_A_indp=at_indp_values[7],
                                     prb_sh2_3_5_A_indp=at_indp_values[8], prb_12_A_indp=at_indp_values[9])
                except ZeroDivisionError:
                    at_indp_appender(prb_HW_A_indp=0.01, prb_AW_A_indp=0.01, prb_15_5_A_indp=0.01, prb_17_5_A_indp=0.01,
                                     prb_19_5_A_indp=0.01, prb_sh1_2_5_A_indp=0.01, prb_sh1_3_5_A_indp=0.01,
                                     prb_sh2_2_5_A_indp=0.01, prb_sh2_3_5_A_indp=0.01, prb_12_A_indp=0.01)
    ...
    try:
        ...
        if len(sub3) == 0:
            h2h_appender(prb_HW=0.01, prb_AW=0.01, prb_15_5=0.01, prb_17_5=0.01, prb_19_5=0.01, prb_sh1_2_5=0.01,
                         prb_sh1_3_5=0.01, prb_sh2_2_5=0.01, prb_sh2_3_5=0.01, prb_12=0.01)
            bth_scores = []
            bta_scores = []
            ...
            if dsc >= DSCRM_BT:
                try:
                    ...
                    h2h_appender(prb_HW=h2h_values[0], prb_AW=h2h_values[1], prb_15_5=h2h_values[2], prb_17_5=h2h_values[3],
                                 prb_19_5=h2h_values[4], prb_sh1_2_5=h2h_values[5], prb_sh1_3_5=h2h_values[6],
                                 prb_sh2_2_5=h2h_values[7], prb_sh2_3_5=h2h_values[8], prb_12=h2h_values[9])
                except ZeroDivisionError:
                    h2h_appender(prb_HW=0.01, prb_AW=0.01, prb_15_5=0.01, prb_17_5=0.01, prb_19_5=0.01, prb_sh1_2_5=0.01,
                                 prb_sh1_3_5=0.01, prb_sh2_2_5=0.01, prb_sh2_3_5=0.01, prb_12=0.01)
            else:
...
def print_all_data():
    ...
    print(f"Prob 15_5s: {prob_15_5s}")
    print(f"Prob 17_5s: {prob_17_5s}")
    print(f"Prob 19_5s: {prob_19_5s}")
    print(f"Prob sh1_1_17_5s: {prob_sh1_2_5s}")
    print(f"Prob sh1_2_17_5s: {prob_sh1_3_5s}")
    print(f"Prob sh2_1_17_5s: {prob_sh2_2_5s}")
    print(f"Prob sh2_2_17_5s: {prob_sh2_3_5s}")
    print(f"Prob 12s: {prob_12s}")
    print(f"Prob HWs: {prob_HWs}")
    print(f"Prob AWs: {prob_AWs}")
    print(f"Prob 15_5_H_indps: {prob_15_5_H_indps}")
    print(f"Prob 17_5_H_indps: {prob_17_5_H_indps}")
    print(f"Prob 19_5_H_indps: {prob_19_5_H_indps}")
    print(f"Prob sh1_2_5_H_indps: {prob_sh1_2_5_H_indps}")
    print(f"Prob sh1_3_5_H_indps: {prob_sh1_3_5_H_indps}")
    print(f"Prob sh2_2_5_H_indps: {prob_sh2_2_5_H_indps}")
    print(f"Prob sh2_3_5_H_indps: {prob_sh2_3_5_H_indps}")
    print(f"Prob 12_H_indps: {prob_12_H_indps}")
    print(f"Prob HW_H_indps: {prob_HW_H_indps}")
    print(f"Prob AW_H_indps: {prob_AW_H_indps}")
    print(f"Prob 15_5_A_indps: {prob_15_5_A_indps}")
    print(f"Prob 17_5_A_indps: {prob_17_5_A_indps}")
    print(f"Prob 19_5_A_indps: {prob_19_5_A_indps}")
    print(f"Prob sh1_2_5_A_indps: {prob_sh1_2_5_A_indps}")
    ...
    print(f"Bayesian 8.5: {bayesian_15_5_d}")
    print(f"Bayesian 9.5: {bayesian_17_5_d}")
    print(f"Bayesian 10.5: {bayesian_19_5_d}")
    print(f"Bayesian sh1_2_5: {bayesian_sh1_2_5_d}")
    print(f"Bayesian 12: {bayesian_12_d}")
    print(f"Odds _1HWS: {_1HWS}")
    print(f"Odds _2AWS: {_2AWS}")
    print(f"Odds OVER_15_5_S: {OVER_15_5_S}")
    print(f"Odds OVER_17_5_S: {OVER_17_5_S}")
    print(f"Odds OVER_19_5_S: {OVER_19_5_S}")
    print(f"Odds OVER_sh1_2_5_S: {OVER_sh1_2_5_S}")
    ...
    print(f"Countries: {len(countries)}, Leagues: {len(leagues)}, Home Teams: {len(home_teams)}, "
          ...
          f"Prob 15_5s: {len(prob_15_5s)}, Prob 17_5s: {len(prob_17_5s)} Prob 19_5s: {len(prob_19_5s)}, Prob 17_5s: {len(prob_sh1_2_5s)},"
          f"Prob 12s: {len(prob_12s)}, Prob HWs: {len(prob_HWs)}, Prob AWs: {len(prob_AWs)}, "
          f"Prob 15_5_H_indps: {len(prob_15_5_H_indps)}, Prob 17_5_H_indps: {len(prob_17_5_H_indps)}, Prob 19_5_H_indps: {len(prob_19_5_H_indps)}, "
          f"Prob 17_5_H_indps: {len(prob_sh1_2_5_H_indps)}, Prob 12_H_indps: {len(prob_12_H_indps)},"
          f"Prob HW_H_indps: {len(prob_HW_H_indps)}, Prob AW_H_indps: {len(prob_AW_H_indps)}, "
          f"Prob 15_5_A_indps: {len(prob_15_5_A_indps)}, Prob 17_5_A_indps: {len(prob_17_5_A_indps)}, Prob 19_5_A_indps: {len(prob_19_5_A_indps)}, "
          f"Prob sh1_2_5_A_indps: {len(prob_sh1_2_5_A_indps)}, Prob 12_A_indps: {len(prob_12_A_indps)}, "
          f"Prob HW_A_indps: {len(prob_HW_A_indps)}, Prob AW_A_indps: {len(prob_AW_A_indps)}, "
          f"Odds _1HWS: {len(_1HWS)}, Odds _2AWS: {len(_2AWS)}, Odds OVER_15_5_S: {len(OVER_17_5_S)},  Odds OVER_17_5_S: {len(OVER_17_5_S)}, "
          f"Odds OVER_19_5_S: {len(OVER_19_5_S)}, Odds OVER_sh1_2_5_S: {len(OVER_sh1_2_5_S)}, Odds _12S: {len(_12S)}"
          f"Bayesian Home Win: {len(bayesian_home_Win_d)}, Bayesian Away Win: {len(bayesian_away_Win_d)}, "
          f"Bayesian 15_5: {len(bayesian_15_5_d)}, Bayesian 5.5: {len(bayesian_17_5_d)}, Bayesian 6.5: {len(bayesian_19_5_d)}, "
          f"Bayesian sh1_2_5: {len(bayesian_sh1_2_5_d)}, Bayesian 12: {len(bayesian_12_d) }")
...
prob_sh1_3_5_H_indps = []
prob_sh2_2_5_H_indps = []
prob_sh2_3_5_H_indps = []
prob_12_H_indps = []
prob_HW_H_indps = []
prob_AW_H_indps = []
prob_15_5_A_indps = []
...
prob_sh1_3_5_A_indps = []
prob_sh2_2_5_A_indps = []
prob_sh2_3_5_A_indps = []
prob_12_A_indps = []
prob_HW_A_indps = []
prob_AW_A_indps = []
home_z_prob = []
    ...
    for COMBINER in COMBINERS[:4]:
        ...
        for COMB in COMB_PROB_METRICS1:
            ...
            for q in range(len(home_teams)):
                try:
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[0]:
                        ...
                        bayesian_15_5 = 0.5 * (rdm.random() + ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q])))))
                        bayesian_17_5 = 0.5 * (rdm.random() + ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q])))))
                        bayesian_19_5 = 0.5 * (rdm.random() + ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q])))))
                        ...
                        bayesian_sh1_3_5 = 0.5 * (rdm.random() + ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q])))))
                        ...
                        bayesian_sh2_3_5 = 0.5 * (rdm.random() + ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q])))))
                        ...
                        baye_appender(baye_HW=bayesian_home_Win, baye_AW=bayesian_away_Win, baye_15_5=bayesian_15_5, baye_17_5=bayesian_17_5, baye_19_5=bayesian_19_5, baye_sh1_2_5=bayesian_sh1_2_5, baye_sh1_3_5=bayesian_sh1_3_5, baye_sh2_2_5=bayesian_sh2_2_5, baye_sh2_3_5=bayesian_sh2_3_5, baye_12=bayesian_12)
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[0]:
                        ...
                        bayesian_15_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) + ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q])))))
                        bayesian_17_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) + ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q])))))
                        bayesian_19_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) + ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q])))))
                        ...
                        bayesian_sh1_3_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) + ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q])))))
                        ...
                        bayesian_sh2_3_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) + ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q])))))
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                        ...
                        bayesian_15_5 = 0.5 * (OVER_15_5_S[q] + ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q])))))
                        bayesian_17_5 = 0.5 * (OVER_17_5_S[q] + ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q])))))
                        bayesian_19_5 = 0.5 * (OVER_19_5_S[q] + ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q])))))
                        ...
                        bayesian_sh1_3_5 = 0.5 * (OVER_sh1_3_5_S[q] + ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q])))))
                        ...
                        bayesian_sh2_3_5 = 0.5 * (OVER_sh2_3_5_S[q] + ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q])))))
                    ...
                    if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[0]:
                        ...
                        bayesian_15_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) + rdm.random())
                        bayesian_17_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) + rdm.random())
                        bayesian_19_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) + rdm.random())
                        bayesian_sh1_2_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_2_5s[q]))) + rdm.random())
                        bayesian_sh1_3_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) + rdm.random())
                        bayesian_sh2_2_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_2_5s[q]))) + rdm.random())
                        bayesian_sh2_3_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) + rdm.random())
                    ...
                    if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                        ...
                        bayesian_15_5 = 0.5 * (OVER_15_5_S[q] + rdm.random())
                        bayesian_17_5 = 0.5 * (OVER_17_5_S[q] + rdm.random())
                        bayesian_19_5 = 0.5 * (OVER_19_5_S[q] + rdm.random())
                        bayesian_sh1_2_5 = 0.5 * (OVER_sh1_2_5_S[q] + rdm.random())
                        bayesian_sh1_3_5 = 0.5 * (OVER_sh1_3_5_S[q] + rdm.random())
                        bayesian_sh2_2_5 = 0.5 * (OVER_sh2_2_5_S[q] + rdm.random())
                        bayesian_sh2_3_5 = 0.5 * (OVER_sh2_3_5_S[q] + rdm.random())
                    ...
                    if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                        ...
                        bayesian_15_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) + OVER_15_5_S[q])
                        bayesian_17_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) + OVER_17_5_S[q])
                        bayesian_19_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) + OVER_19_5_S[q])
                        bayesian_sh1_2_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_2_5s[q]))) + OVER_sh1_2_5_S[q])
                        bayesian_sh1_3_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) + OVER_sh1_3_5_S[q])
                        bayesian_sh2_2_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_2_5s[q]))) + OVER_sh2_2_5_S[q])
                        bayesian_sh2_3_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) + OVER_sh2_3_5_S[q])
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[1]:
                        ...
                        bayesian_15_5 = rdm.random() * ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q]))))
                        bayesian_17_5 = rdm.random() * ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q]))))
                        bayesian_19_5 = rdm.random() * ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q]))))
                        ...
                        bayesian_sh1_3_5 = rdm.random() * ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q]))))
                        ...
                        bayesian_sh2_3_5 = rdm.random() * ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q]))))
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[1]:
                        ...
                        bayesian_15_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q]))))
                        bayesian_17_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q]))))
                        bayesian_19_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q]))))
                        ...
                        bayesian_sh1_3_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q]))))
                        ...
                        bayesian_sh2_3_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q]))))
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                        ...
                        bayesian_15_5 = OVER_15_5_S[q] * ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q]))))
                        bayesian_17_5 = OVER_17_5_S[q] * ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q]))))
                        bayesian_19_5 = OVER_19_5_S[q] * ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q]))))
                        ...
                        bayesian_sh1_3_5 = OVER_sh1_3_5_S[q] * ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q]))))
                        ...
                        bayesian_sh2_3_5 = OVER_sh2_3_5_S[q] * ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q]))))
                    ...
                    if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[1]:
                        ...
                        bayesian_15_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * rdm.random()
                        bayesian_17_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * rdm.random()
                        bayesian_19_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * rdm.random()
                        bayesian_sh1_2_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_2_5s[q]))) * rdm.random()
                        bayesian_sh1_3_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * rdm.random()
                        bayesian_sh2_2_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_2_5s[q]))) * rdm.random()
                        bayesian_sh2_3_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * rdm.random()
                    ...
                    if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                        ...
                        bayesian_15_5 = OVER_15_5_S[q] * rdm.random()
                        bayesian_17_5 = OVER_17_5_S[q] * rdm.random()
                        bayesian_19_5 = OVER_19_5_S[q] * rdm.random()
                        bayesian_sh1_2_5 = OVER_sh1_2_5_S[q] * rdm.random()
                        bayesian_sh1_3_5 = OVER_sh1_3_5_S[q] * rdm.random()
                        bayesian_sh2_2_5 = OVER_sh2_2_5_S[q] * rdm.random()
                        bayesian_sh2_3_5 = OVER_sh2_3_5_S[q] * rdm.random()
                    ...
                    if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                        ...
                        bayesian_15_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * OVER_15_5_S[q]
                        bayesian_17_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * OVER_17_5_S[q]
                        bayesian_19_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * OVER_19_5_S[q]
                        bayesian_sh1_2_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_2_5s[q]))) * OVER_sh1_2_5_S[q]
                        bayesian_sh1_3_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * OVER_sh1_3_5_S[q]
                        bayesian_sh2_2_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_2_5s[q]))) * OVER_sh2_2_5_S[q]
                        bayesian_sh2_3_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * OVER_sh2_3_5_S[q]
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[2]:
                        ...
                        bayesian_15_5 = math.sqrt(0.5 * (rdm.random() + ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q]))))))
                        bayesian_17_5 = math.sqrt(0.5 * (rdm.random() + ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q]))))))
                        bayesian_19_5 = math.sqrt(0.5 * (rdm.random() + ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q]))))))
                        ...
                        bayesian_sh1_3_5 = math.sqrt(0.5 * (rdm.random() + ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q]))))))
                        ...
                        bayesian_sh2_3_5 = math.sqrt(0.5 * (rdm.random() + ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q]))))))
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[2]:
                        ...
                        bayesian_15_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) + ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q]))))))
                        bayesian_17_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) + ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q]))))))
                        bayesian_19_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) + ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q]))))))
                        ...
                        bayesian_sh1_3_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) + ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q]))))))
                        ...
                        bayesian_sh2_3_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) + ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q]))))))
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[2]:
                        ...
                        bayesian_15_5 = math.sqrt(0.5 * (OVER_15_5_S[q] + ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q]))))))
                        bayesian_17_5 = math.sqrt(0.5 * (OVER_17_5_S[q] + ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q]))))))
                        bayesian_19_5 = math.sqrt(0.5 * (OVER_19_5_S[q] + ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q]))))))
                        ...
                        bayesian_sh1_3_5 = math.sqrt(0.5 * (OVER_sh1_3_5_S[q] + ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q]))))))
                        ...
                        bayesian_sh2_3_5 = math.sqrt(0.5 * (OVER_sh2_3_5_S[q] + ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q]))))))
                    ...
                    if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[2]:
                        ...
                        bayesian_15_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) + rdm.random()))
                        bayesian_17_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) + rdm.random()))
                        bayesian_19_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) + rdm.random()))
                        bayesian_sh1_2_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_2_5s[q]))) + rdm.random()))
                        bayesian_sh1_3_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) + rdm.random()))
                        bayesian_sh2_2_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_2_5s[q]))) + rdm.random()))
                        bayesian_sh2_3_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) + rdm.random()))
                    ...
                    if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[2]:
                        ...
                        bayesian_15_5 = math.sqrt(0.5 * (OVER_15_5_S[q] + rdm.random()))
                        bayesian_17_5 = math.sqrt(0.5 * (OVER_17_5_S[q] + rdm.random()))
                        bayesian_19_5 = math.sqrt(0.5 * (OVER_19_5_S[q] + rdm.random()))
                        bayesian_sh1_2_5 = math.sqrt(0.5 * (OVER_sh1_2_5_S[q] + rdm.random()))
                        bayesian_sh1_3_5 = math.sqrt(0.5 * (OVER_sh1_3_5_S[q] + rdm.random()))
                        bayesian_sh2_2_5 = math.sqrt(0.5 * (OVER_sh2_2_5_S[q] + rdm.random()))
                        bayesian_sh2_3_5 = math.sqrt(0.5 * (OVER_sh2_3_5_S[q] + rdm.random()))
                    ...
                    if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[2]:
                        ...
                        bayesian_15_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) + OVER_15_5_S[q]))
                        bayesian_17_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) + OVER_17_5_S[q]))
                        bayesian_19_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) + OVER_19_5_S[q]))
                        bayesian_sh1_2_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_2_5s[q]))) + OVER_sh1_2_5_S[q]))
                        bayesian_sh1_3_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) + OVER_sh1_3_5_S[q]))
                        bayesian_sh2_2_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_2_5s[q]))) + OVER_sh2_2_5_S[q]))
                        bayesian_sh2_3_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) + OVER_sh2_3_5_S[q]))
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[3]:
                        ...
                        bayesian_15_5 = math.sqrt(rdm.random() * ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q])))))
                        bayesian_17_5 = math.sqrt(rdm.random() * ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q])))))
                        bayesian_19_5 = math.sqrt(rdm.random() * ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q])))))
                        ...
                        bayesian_sh1_3_5 = math.sqrt(rdm.random() * ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q])))))
                        ...
                        bayesian_sh2_3_5 = math.sqrt(rdm.random() * ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q])))))
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[3]:
                        ...
                        bayesian_15_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q])))))
                        bayesian_17_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q])))))
                        bayesian_19_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q])))))
                        ...
                        bayesian_sh1_3_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q])))))
                        ...
                        bayesian_sh2_3_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q])))))
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[3]:
                        ...
                        bayesian_15_5 = math.sqrt(OVER_15_5_S[q] * ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q])))))
                        bayesian_17_5 = math.sqrt(OVER_17_5_S[q] * ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q])))))
                        bayesian_19_5 = math.sqrt(OVER_19_5_S[q] * ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q])))))
                        ...
                        bayesian_sh1_3_5 = math.sqrt(OVER_sh1_3_5_S[q] * ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q])))))
                        ...
                        bayesian_sh2_3_5 = math.sqrt(OVER_sh2_3_5_S[q] * ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q])))))
                    ...
                    if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[3]:
                        ...
                        bayesian_15_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * rdm.random())
                        bayesian_17_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * rdm.random())
                        bayesian_19_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * rdm.random())
                        bayesian_sh1_2_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_2_5s[q]))) * rdm.random())
                        bayesian_sh1_3_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * rdm.random())
                        bayesian_sh2_2_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_2_5s[q]))) * rdm.random())
                        bayesian_sh2_3_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * rdm.random())
                    ...
                    if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[3]:
                        ...
                        bayesian_15_5 = math.sqrt(OVER_15_5_S[q] * rdm.random())
                        bayesian_17_5 = math.sqrt(OVER_17_5_S[q] * rdm.random())
                        bayesian_19_5 = math.sqrt(OVER_19_5_S[q] * rdm.random())
                        bayesian_sh1_2_5 = math.sqrt(OVER_sh1_2_5_S[q] * rdm.random())
                        bayesian_sh1_3_5 = math.sqrt(OVER_sh1_3_5_S[q] * rdm.random())
                        bayesian_sh2_2_5 = math.sqrt(OVER_sh2_2_5_S[q] * rdm.random())
                        bayesian_sh2_3_5 = math.sqrt(OVER_sh2_3_5_S[q] * rdm.random())
                    ...
                    if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[3]:
                        ...
                        bayesian_15_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * OVER_15_5_S[q])
                        bayesian_17_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * OVER_17_5_S[q])
                        bayesian_19_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * OVER_19_5_S[q])
                        bayesian_sh1_2_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_2_5s[q]))) * OVER_sh1_2_5_S[q])
                        bayesian_sh1_3_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * OVER_sh1_3_5_S[q])
                        bayesian_sh2_2_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_2_5s[q]))) * OVER_sh2_2_5_S[q])
                        bayesian_sh2_3_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * OVER_sh2_3_5_S[q])
            ...
            for q in range(len(bayesian_home_Win_d)):
                ...
                try:
                    if bayesian_17_5_d[q] > CONFINTVL or bayesian_19_5_d[q] > CONFINTVL or bayesian_sh1_2_5_d[q] > CONFINTVL or bayesian_sh2_2_5_d[q] > CONFINTVL:
                            ...
                            if h_form_D[q] == 0 and a_form_D[q] == 0:
                                if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                    if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                        if bayesian_19_5_d[q] <= bayesian_17_5_d[q] <= bayesian_15_5_d[q] and bayesian_sh1_3_5_d[q] >= bayesian_sh1_2_5_d[q] and bayesian_sh2_3_5_d[q] >= bayesian_sh2_2_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF:
                                        ...
                                        if bayesian_19_5_d[q] <= bayesian_17_5_d[q] <= bayesian_15_5_d[q] and bayesian_sh1_3_5_d[q] >= bayesian_sh1_2_5_d[q] and bayesian_sh2_3_5_d[q] >= bayesian_sh2_2_5_d[q] and BAY_DIFF <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= bayesian_12_d[q] and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                            with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                writer(w=q, A=X, B=Y, C=Z, data=file)
                        ...
                        if home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP:
                            if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                    ...
                                    if bayesian_19_5_d[q] <= bayesian_17_5_d[q] <= bayesian_15_5_d[q] and bayesian_sh1_3_5_d[q] >= bayesian_sh1_2_5_d[q] and bayesian_sh2_3_5_d[q] >= bayesian_sh2_2_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                        if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                            with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                writer(w=q, A=X, B=Y, C=Z, data=file)
        ...
        for q in range(len(home_teams)):
            try:
                if X == PROB_METRICS[0]:
                    ...
                    bayesian_15_5 = (prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q])))
                    bayesian_17_5 = (prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q])))
                    bayesian_19_5 = (prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q])))
                    ...
                    bayesian_sh1_3_5 = (prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q])))
                    ...
                    bayesian_sh2_3_5 = (prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q])))
                ...
                if X == PROB_METRICS[1]:
                    ...
                    prob_15_5 = rdm.random()
                    prob_15_5_indp_home = rdm.random()
                    prob_15_5_indp_away = rdm.random()
                    bayesian_15_5 = (prob_15_5 * (prob_15_5_indp_home * prob_15_5_indp_away)) / ((prob_15_5 * (prob_15_5_indp_home * prob_15_5_indp_away)) + ((1 - (prob_15_5_indp_home * prob_15_5_indp_away)) * (1 - prob_15_5)))
                    prob_17_5 = rdm.random()
                    prob_17_5_indp_home = rdm.random()
                    prob_17_5_indp_away = rdm.random()
                    bayesian_17_5 = (prob_17_5 * (prob_17_5_indp_home * prob_17_5_indp_away)) / ((prob_17_5 * (prob_17_5_indp_home * prob_17_5_indp_away)) + ((1 - (prob_17_5_indp_home * prob_17_5_indp_away)) * (1 - prob_17_5)))
                    prob_19_5 = rdm.random()
                    prob_19_5_indp_home = rdm.random()
                    prob_19_5_indp_away = rdm.random()
                    bayesian_19_5 = (prob_19_5 * (prob_19_5_indp_home * prob_19_5_indp_away)) / ((prob_19_5 * (prob_19_5_indp_home * prob_19_5_indp_away)) + ((1 - (prob_19_5_indp_home * prob_19_5_indp_away)) * (1 - prob_19_5)))
                    ...
                    prob_sh1_3_5 = rdm.random()
                    prob_sh1_3_5_indp_home = rdm.random()
                    prob_sh1_3_5_indp_away = rdm.random()
                    bayesian_sh1_3_5 = (prob_sh1_3_5 * (prob_sh1_3_5_indp_home * prob_sh1_3_5_indp_away)) / ((prob_sh1_3_5 * (prob_sh1_3_5_indp_home * prob_sh1_3_5_indp_away)) + ((1 - (prob_sh1_3_5_indp_home * prob_sh1_3_5_indp_away)) * (1 - prob_sh1_3_5)))
                    ...
                    prob_sh2_3_5 = rdm.random()
                    prob_sh2_3_5_indp_home = rdm.random()
                    prob_sh2_3_5_indp_away = rdm.random()
                    bayesian_sh2_3_5 = (prob_sh2_3_5 * (prob_sh2_3_5_indp_home * prob_sh2_3_5_indp_away)) / ((prob_sh2_3_5 * (prob_sh2_3_5_indp_home * prob_sh2_3_5_indp_away)) + ((1 - (prob_sh2_3_5_indp_home * prob_sh2_3_5_indp_away)) * (1 - prob_sh2_3_5)))
                    prob_12 = rdm.random()
                ...
                if X == PROB_METRICS[2]:
                    ...
                    bayesian_15_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))
                    bayesian_17_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))
                    bayesian_19_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))
                    bayesian_sh1_2_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_2_5s[q]))
                    bayesian_sh1_3_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))
                    bayesian_sh2_2_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_2_5s[q]))
                    bayesian_sh2_3_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))
                ...
                if X == PROB_METRICS[3]:
                    ...
                    bayesian_15_5 = OVER_15_5_S[q]
                    bayesian_17_5 = OVER_17_5_S[q]
                    bayesian_19_5 = OVER_19_5_S[q]
                    bayesian_sh1_2_5 = OVER_sh1_2_5_S[q]
                    bayesian_sh1_3_5 = OVER_sh1_3_5_S[q]
                    bayesian_sh2_2_5 = OVER_sh2_2_5_S[q]
                    bayesian_sh2_3_5 = OVER_sh2_3_5_S[q]
                    bayesian_12 = _12S[q]
                    baye_appender(baye_HW=bayesian_home_Win, baye_AW=bayesian_away_Win, baye_15_5=bayesian_15_5, baye_17_5=bayesian_17_5, baye_19_5=bayesian_19_5, baye_sh1_2_5=bayesian_sh1_2_5, baye_sh1_3_5=bayesian_sh1_3_5, baye_sh2_2_5=bayesian_sh2_2_5, baye_sh2_3_5=bayesian_sh2_3_5, baye_12=bayesian_12)
                ...
                if X == PROB_METRICS[4]:
                    ...
                    bayesian_15_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q])) * diff_z_prob[q]
                    bayesian_17_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q])) * diff_z_prob[q]
                    bayesian_19_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q])) * diff_z_prob[q]
                    bayesian_sh1_2_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_2_5s[q])) * diff_z_prob[q]
                    bayesian_sh1_3_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q])) * diff_z_prob[q]
                    bayesian_sh2_2_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_2_5s[q])) * diff_z_prob[q]
                    bayesian_sh2_3_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q])) * diff_z_prob[q]
        ...
        for q in range(len(home_teams)):
            try:
                if X == PROB_METRICS1[0] and Y == PROB_METRICS1[1]:
                    ...
                    prob_15_5_indp_home = rdm.random()
                    prob_15_5_indp_away = rdm.random()
                    bayesian_15_5 = (prob_15_5s[q] * (prob_15_5_indp_home * prob_15_5_indp_away)) / ((prob_15_5s[q] * (prob_15_5_indp_home * prob_15_5_indp_away)) + ((1 - (prob_15_5_indp_home * prob_15_5_indp_away)) * (1 - prob_15_5s[q])))
                    prob_17_5_indp_home = rdm.random()
                    prob_17_5_indp_away = rdm.random()
                    bayesian_17_5 = (prob_17_5s[q] * (prob_17_5_indp_home * prob_17_5_indp_away)) / ((prob_17_5s[q] * (prob_17_5_indp_home * prob_17_5_indp_away)) + ((1 - (prob_17_5_indp_home * prob_17_5_indp_away)) * (1 - prob_17_5s[q])))
                    prob_19_5_indp_home = rdm.random()
                    prob_19_5_indp_away = rdm.random()
                    bayesian_19_5 = (prob_19_5s[q] * (prob_19_5_indp_home * prob_19_5_indp_away)) / ((prob_19_5s[q] * (prob_19_5_indp_home * prob_19_5_indp_away)) + ((1 - (prob_19_5_indp_home * prob_19_5_indp_away)) * (1 - prob_19_5s[q])))
                    prob_sh1_2_5_indp_home = rdm.random()
                    prob_sh1_2_5_indp_away = rdm.random()
                    ...
                    prob_sh1_3_5_indp_home = rdm.random()
                    prob_sh1_3_5_indp_away = rdm.random()
                    bayesian_sh1_3_5 = (prob_sh1_3_5s[q] * (prob_sh1_3_5_indp_home * prob_sh1_3_5_indp_away)) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_indp_home * prob_sh1_3_5_indp_away)) + ((1 - (prob_sh1_3_5_indp_home * prob_sh1_3_5_indp_away)) * (1 - prob_sh1_3_5s[q])))
                    prob_sh2_2_5_indp_home = rdm.random()
                    prob_sh2_2_5_indp_away = rdm.random()
                    ...
                    prob_sh2_3_5_indp_home = rdm.random()
                    prob_sh2_3_5_indp_away = rdm.random()
                    bayesian_sh2_3_5 = (prob_sh2_3_5s[q] * (prob_sh2_3_5_indp_home * prob_sh2_3_5_indp_away)) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_indp_home * prob_sh2_3_5_indp_away)) + ((1 - (prob_sh2_3_5_indp_home * prob_sh2_3_5_indp_away)) * (1 - prob_sh2_3_5s[q])))
                    prob_12_indp_home = rdm.random()
                    prob_12_indp_away = rdm.random()
                ...
                if X == PROB_METRICS1[0] and Y == PROB_METRICS1[2]:
                    ...
                    prob_15_5_indp_home = rdm.random()
                    prob_15_5_indp_away = rdm.random()
                    bayesian_15_5 = (((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * (prob_15_5_indp_home * prob_15_5_indp_away)) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * (prob_15_5_indp_home * prob_15_5_indp_away)) + ((1 - (prob_15_5_indp_home * prob_15_5_indp_away)) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q])))))))
                    prob_17_5_indp_home = rdm.random()
                    prob_17_5_indp_away = rdm.random()
                    bayesian_17_5 = (((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * (prob_17_5_indp_home * prob_17_5_indp_away)) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * (prob_17_5_indp_home * prob_17_5_indp_away)) + ((1 - (prob_17_5_indp_home * prob_17_5_indp_away)) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q])))))))
                    prob_19_5_indp_home = rdm.random()
                    prob_19_5_indp_away = rdm.random()
                    bayesian_19_5 = (((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * (prob_19_5_indp_home * prob_19_5_indp_away)) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * (prob_19_5_indp_home * prob_19_5_indp_away)) + ((1 - (prob_19_5_indp_home * prob_19_5_indp_away)) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q])))))))
                    prob_sh1_2_5_indp_home = rdm.random()
                    prob_sh1_2_5_indp_away = rdm.random()
                    ...
                    prob_sh1_3_5_indp_home = rdm.random()
                    prob_sh1_3_5_indp_away = rdm.random()
                    bayesian_sh1_3_5 = (((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * (prob_sh1_3_5_indp_home * prob_sh1_3_5_indp_away)) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * (prob_sh1_3_5_indp_home * prob_sh1_3_5_indp_away)) + ((1 - (prob_sh1_3_5_indp_home * prob_sh1_3_5_indp_away)) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q])))))))
                    prob_sh2_2_5_indp_home = rdm.random()
                    prob_sh2_2_5_indp_away = rdm.random()
                    ...
                    prob_sh2_3_5_indp_home = rdm.random()
                    prob_sh2_3_5_indp_away = rdm.random()
                    bayesian_sh2_3_5 = (((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * (prob_sh2_3_5_indp_home * prob_sh2_3_5_indp_away)) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * (prob_sh2_3_5_indp_home * prob_sh2_3_5_indp_away)) + ((1 - (prob_sh2_3_5_indp_home * prob_sh2_3_5_indp_away)) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q])))))))
                    prob_12_indp_home = rdm.random()
                    prob_12_indp_away = rdm.random()
                ...
                if X == PROB_METRICS1[0] and Y == PROB_METRICS1[3]:
                    ...
                    prob_15_5_indp_home = rdm.random()
                    prob_15_5_indp_away = rdm.random()
                    bayesian_15_5 = (OVER_15_5_S[q] * (prob_15_5_indp_home * prob_15_5_indp_away)) / ((OVER_15_5_S[q] * (prob_15_5_indp_home * prob_15_5_indp_away)) + ((1 - (prob_15_5_indp_home * prob_15_5_indp_away)) * (1 - OVER_15_5_S[q])))
                    prob_17_5_indp_home = rdm.random()
                    prob_17_5_indp_away = rdm.random()
                    bayesian_17_5 = (OVER_17_5_S[q] * (prob_17_5_indp_home * prob_17_5_indp_away)) / ((OVER_17_5_S[q] * (prob_17_5_indp_home * prob_17_5_indp_away)) + ((1 - (prob_17_5_indp_home * prob_17_5_indp_away)) * (1 - OVER_17_5_S[q])))
                    prob_19_5_indp_home = rdm.random()
                    prob_19_5_indp_away = rdm.random()
                    bayesian_19_5 = (OVER_19_5_S[q] * (prob_19_5_indp_home * prob_19_5_indp_away)) / ((OVER_19_5_S[q] * (prob_19_5_indp_home * prob_19_5_indp_away)) + ((1 - (prob_19_5_indp_home * prob_19_5_indp_away)) * (1 - OVER_19_5_S[q])))
                    prob_sh1_2_5_indp_home = rdm.random()
                    prob_sh1_2_5_indp_away = rdm.random()
                    ...
                    prob_sh1_3_5_indp_home = rdm.random()
                    prob_sh1_3_5_indp_away = rdm.random()
                    bayesian_sh1_3_5 = (OVER_sh1_3_5_S[q] * (prob_sh1_3_5_indp_home * prob_sh1_3_5_indp_away)) / ((OVER_sh1_3_5_S[q] * (prob_sh1_3_5_indp_home * prob_sh1_3_5_indp_away)) + ((1 - (prob_sh1_3_5_indp_home * prob_sh1_3_5_indp_away)) * (1 - OVER_sh1_3_5_S[q])))
                    prob_sh2_2_5_indp_home = rdm.random()
                    prob_sh2_2_5_indp_away = rdm.random()
                    ...
                    prob_sh2_3_5_indp_home = rdm.random()
                    prob_sh2_3_5_indp_away = rdm.random()
                    bayesian_sh2_3_5 = (OVER_sh2_3_5_S[q] * (prob_sh2_3_5_indp_home * prob_sh2_3_5_indp_away)) / ((OVER_sh2_3_5_S[q] * (prob_sh2_3_5_indp_home * prob_sh2_3_5_indp_away)) + ((1 - (prob_sh2_3_5_indp_home * prob_sh2_3_5_indp_away)) * (1 - OVER_sh2_3_5_S[q])))
                    prob_12_indp_home = rdm.random()
                    prob_12_indp_away = rdm.random()
                ...
                if X == PROB_METRICS1[1] and Y == PROB_METRICS1[0]:
                    ...
                    prob_15_5 = rdm.random()
                    bayesian_15_5 = ((prob_15_5 * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5 * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5))))
                    prob_17_5 = rdm.random()
                    bayesian_17_5 = ((prob_17_5 * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5 * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5))))
                    prob_19_5 = rdm.random()
                    bayesian_19_5 = ((prob_19_5 * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5 * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5))))
                    prob_sh1_2_5 = rdm.random()
                    ...
                    prob_sh1_3_5 = rdm.random()
                    bayesian_sh1_3_5 = ((prob_sh1_3_5 * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5 * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5))))
                    prob_sh2_2_5 = rdm.random()
                    ...
                    prob_sh2_3_5 = rdm.random()
                    bayesian_sh2_3_5 = ((prob_sh2_3_5 * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5 * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5))))
                    prob_12 = rdm.random()
                ...
                if X == PROB_METRICS1[1] and Y == PROB_METRICS1[2]:
                    ...
                    bayesian_15_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))))))
                    bayesian_17_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))))))
                    bayesian_19_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))))))
                    ...
                    bayesian_sh1_3_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))))))
                    ...
                    bayesian_sh2_3_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))))))
                ...
                if X == PROB_METRICS1[1] and Y == PROB_METRICS1[3]:
                    ...
                    bayesian_15_5 = (OVER_15_5_S[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((OVER_15_5_S[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - OVER_15_5_S[q])))
                    bayesian_17_5 = (OVER_17_5_S[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((OVER_17_5_S[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - OVER_17_5_S[q])))
                    bayesian_19_5 = (OVER_19_5_S[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((OVER_19_5_S[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - OVER_19_5_S[q])))
                    ...
                    bayesian_sh1_3_5 = (OVER_sh1_3_5_S[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((OVER_sh1_3_5_S[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - OVER_sh1_3_5_S[q])))
                    ...
                    bayesian_sh2_3_5 = (OVER_sh2_3_5_S[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((OVER_sh2_3_5_S[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - OVER_sh2_3_5_S[q])))
                ...
                for q in range(len(home_teams)):
                    try:
                        if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[0]:
                            ...
                            bayesian_15_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) + rdm.random() + ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q])))))
                            bayesian_17_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) + rdm.random() + ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q])))))
                            bayesian_19_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) + rdm.random() + ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q])))))
                            ...
                            bayesian_sh1_3_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) + rdm.random() + ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q])))))
                            ...
                            bayesian_sh2_3_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) + rdm.random() + ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q])))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[1]:
                            ...
                            bayesian_15_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * rdm.random() * ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q]))))
                            bayesian_17_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * rdm.random() * ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q]))))
                            bayesian_19_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * rdm.random() * ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q]))))
                            ...
                            bayesian_sh1_3_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * rdm.random() * ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q]))))
                            ...
                            bayesian_sh2_3_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * rdm.random() * ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q]))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[4]:
                            ...
                            bayesian_15_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) + rdm.random() + ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q]))))))
                            bayesian_17_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) + rdm.random() + ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q]))))))
                            bayesian_19_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) + rdm.random() + ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q]))))))
                            ...
                            bayesian_sh1_3_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) + rdm.random() + ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q]))))))
                            ...
                            bayesian_sh2_3_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) + rdm.random() + ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q]))))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                            ...
                            bayesian_15_5 = (1 / 3) * (OVER_15_5_S[q] + rdm.random() + ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q])))))
                            bayesian_17_5 = (1 / 3) * (OVER_17_5_S[q] + rdm.random() + ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q])))))
                            bayesian_19_5 = (1 / 3) * (OVER_19_5_S[q] + rdm.random() + ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q])))))
                            ...
                            bayesian_sh1_3_5 = (1 / 3) * (OVER_sh1_3_5_S[q] + rdm.random() + ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q])))))
                            ...
                            bayesian_sh2_3_5 = (1 / 3) * (OVER_sh2_3_5_S[q] + rdm.random() + ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q])))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                            ...
                            bayesian_15_5 = OVER_15_5_S[q] * rdm.random() * ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q]))))
                            bayesian_17_5 = OVER_17_5_S[q] * rdm.random() * ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q]))))
                            bayesian_19_5 = OVER_19_5_S[q] * rdm.random() * ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q]))))
                            ...
                            bayesian_sh1_3_5 = OVER_sh1_3_5_S[q] * rdm.random() * ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q]))))
                            ...
                            bayesian_sh2_3_5 = OVER_sh2_3_5_S[q] * rdm.random() * ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q]))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[4]:
                            ...
                            bayesian_15_5 = np.cbrt((1 / 3) * (OVER_15_5_S[q] + rdm.random() + ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q]))))))
                            bayesian_17_5 = np.cbrt((1 / 3) * (OVER_17_5_S[q] + rdm.random() + ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q]))))))
                            bayesian_19_5 = np.cbrt((1 / 3) * (OVER_19_5_S[q] + rdm.random() + ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q]))))))
                            ...
                            bayesian_sh1_3_5 = np.cbrt((1 / 3) * (OVER_sh1_3_5_S[q] + rdm.random() + ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q]))))))
                            ...
                            bayesian_sh2_3_5 = np.cbrt((1 / 3) * (OVER_sh2_3_5_S[q] + rdm.random() + ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q]))))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[5]:
                            ...
                            bayesian_15_5 = np.cbrt(OVER_15_5_S[q] * rdm.random() * ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q])))))
                            bayesian_17_5 = np.cbrt(OVER_17_5_S[q] * rdm.random() * ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q])))))
                            bayesian_19_5 = np.cbrt(OVER_19_5_S[q] * rdm.random() * ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q])))))
                            ...
                            bayesian_sh1_3_5 = np.cbrt(OVER_sh1_3_5_S[q] * rdm.random() * ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q])))))
                            ...
                            bayesian_sh2_3_5 = np.cbrt(OVER_sh2_3_5_S[q] * rdm.random() * ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q])))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                            ...
                            bayesian_15_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) + OVER_15_5_S[q] + ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q])))))
                            bayesian_17_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) + OVER_17_5_S[q] + ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q])))))
                            bayesian_19_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) + OVER_19_5_S[q] + ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q])))))
                            ...
                            bayesian_sh1_3_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) + OVER_sh1_3_5_S[q] + ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q])))))
                            ...
                            bayesian_sh2_3_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) + OVER_sh2_3_5_S[q] + ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q])))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                            ...
                            bayesian_15_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * OVER_15_5_S[q] * ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q]))))
                            bayesian_17_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * OVER_17_5_S[q] * ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q]))))
                            bayesian_19_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * OVER_19_5_S[q] * ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q]))))
                            ...
                            bayesian_sh1_3_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * OVER_sh1_3_5_S[q] * ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q]))))
                            ...
                            bayesian_sh2_3_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * OVER_sh2_3_5_S[q] * ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q]))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[4]:
                            ...
                            bayesian_15_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) + OVER_15_5_S[q] + ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q]))))))
                            bayesian_17_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) + OVER_17_5_S[q] + ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q]))))))
                            bayesian_19_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) + OVER_19_5_S[q] + ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q]))))))
                            ...
                            bayesian_sh1_3_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) + OVER_sh1_3_5_S[q] + ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q]))))))
                            ...
                            bayesian_sh2_3_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) + OVER_sh2_3_5_S[q] + ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q]))))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[5]:
                            ...
                            bayesian_15_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * OVER_15_5_S[q] * ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q])))))
                            bayesian_17_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * OVER_17_5_S[q] * ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q])))))
                            bayesian_19_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * OVER_19_5_S[q] * ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q])))))
                            ...
                            bayesian_sh1_3_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * OVER_sh1_3_5_S[q] * ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q])))))
                            ...
                            bayesian_sh2_3_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * OVER_sh2_3_5_S[q] * ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q])))))
                        ...
                        if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                            ...
                            bayesian_15_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) + rdm.random() + OVER_15_5_S[q])
                            bayesian_17_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) + rdm.random() + OVER_17_5_S[q])
                            bayesian_19_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) + rdm.random() + OVER_19_5_S[q])
                            bayesian_sh1_2_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_2_5s[q]))) + rdm.random() + OVER_sh1_2_5_S[q])
                            bayesian_sh1_3_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) + rdm.random() + OVER_sh1_3_5_S[q])
                            bayesian_sh2_2_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_2_5s[q]))) + rdm.random() + OVER_sh2_2_5_S[q])
                            bayesian_sh2_3_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) + rdm.random() + OVER_sh2_3_5_S[q])
                        ...
                        if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                            ...
                            bayesian_15_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * rdm.random() * OVER_15_5_S[q]
                            bayesian_17_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * rdm.random() * OVER_17_5_S[q]
                            bayesian_19_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * rdm.random() * OVER_19_5_S[q]
                            bayesian_sh1_2_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_2_5s[q]))) * rdm.random() * OVER_sh1_2_5_S[q]
                            bayesian_sh1_3_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * rdm.random() * OVER_sh1_3_5_S[q]
                            bayesian_sh2_2_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_2_5s[q]))) * rdm.random() * OVER_sh2_2_5_S[q]
                            bayesian_sh2_3_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * rdm.random() * OVER_sh2_3_5_S[q]
                        ...
                        if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[4]:
                            ...
                            bayesian_15_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) + rdm.random() + OVER_15_5_S[q]))
                            bayesian_17_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) + rdm.random() + OVER_17_5_S[q]))
                            bayesian_19_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) + rdm.random() + OVER_19_5_S[q]))
                            bayesian_sh1_2_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_2_5s[q]))) + rdm.random() + OVER_sh1_2_5_S[q]))
                            bayesian_sh1_3_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) + rdm.random() + OVER_sh1_3_5_S[q]))
                            bayesian_sh2_2_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_2_5s[q]))) + rdm.random() + OVER_sh2_2_5_S[q]))
                            bayesian_sh2_3_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) + rdm.random() + OVER_sh2_3_5_S[q]))
                        ...
                        if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[5]:
                            ...
                            bayesian_15_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * rdm.random() * OVER_15_5_S[q])
                            bayesian_17_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * rdm.random() * OVER_17_5_S[q])
                            bayesian_19_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * rdm.random() * OVER_19_5_S[q])
                            bayesian_sh1_2_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_2_5s[q]))) * rdm.random() * OVER_sh1_2_5_S[q])
                            bayesian_sh1_3_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * rdm.random() * OVER_sh1_3_5_S[q])
                            bayesian_sh2_2_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_2_5s[q]))) * rdm.random() * OVER_sh2_2_5_S[q])
                            bayesian_sh2_3_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * rdm.random() * OVER_sh2_3_5_S[q])
                                ...
                                if h_form_D[q] == 0 and a_form_D[q] == 0:
                                    if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                        if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                            if bayesian_19_5_d[q] <= bayesian_17_5_d[q] <= bayesian_15_5_d[q] and bayesian_sh1_3_5_d[q] >= bayesian_sh1_2_5_d[q] and bayesian_sh2_3_5_d[q] >= bayesian_sh2_2_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2):
                                                if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                    with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                        writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                                        else:
                                            if bayesian_19_5_d[q] <= bayesian_17_5_d[q] <= bayesian_15_5_d[q] and bayesian_sh1_3_5_d[q] >= bayesian_sh1_2_5_d[q] and bayesian_sh2_3_5_d[q] >= bayesian_sh2_2_5_d[q] and (BAY_DIFF / 2) <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= (0.5 * bayesian_12_d[q]):
                                                with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                    writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                            ...
                            if home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP:
                                if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                    if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                        ...
                                        if bayesian_19_5_d[q] <= bayesian_17_5_d[q] <= bayesian_15_5_d[q] and bayesian_sh1_3_5_d[q] >= bayesian_sh1_2_5_d[q] and bayesian_sh2_3_5_d[q] >= bayesian_sh2_2_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2) and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                            if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                    writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                ...
                for q in range(len(home_teams)):
                    try:
                        if Z == COMBINERS[0]:
                            ...
                            bayesian_15_5 = (1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) + rdm.random() + OVER_15_5_S[q] + ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q])))))
                            bayesian_17_5 = (1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) + rdm.random() + OVER_17_5_S[q] + ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q])))))
                            bayesian_19_5 = (1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) + rdm.random() + OVER_19_5_S[q] + ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q])))))
                            ...
                            bayesian_sh1_3_5 = (1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) + rdm.random() + OVER_sh1_3_5_S[q] + ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q])))))
                            ...
                            bayesian_sh2_3_5 = (1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) + rdm.random() + OVER_sh2_3_5_S[q] + ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q])))))
                        ...
                        if Z == COMBINERS[1]:
                            ...
                            bayesian_15_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * rdm.random() * OVER_15_5_S[q] * ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q]))))
                            bayesian_17_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * rdm.random() * OVER_17_5_S[q] * ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q]))))
                            bayesian_19_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * rdm.random() * OVER_19_5_S[q] * ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q]))))
                            ...
                            bayesian_sh1_3_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * rdm.random() * OVER_sh1_3_5_S[q] * ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q]))))
                            ...
                            bayesian_sh2_3_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * rdm.random() * OVER_sh2_3_5_S[q] * ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q]))))
                        ...
                        if Z == COMBINERS[6]:
                            ...
                            bayesian_15_5 = ((1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) + rdm.random() + OVER_15_5_S[q] + ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q])))))) ** 0.25
                            bayesian_17_5 = ((1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) + rdm.random() + OVER_17_5_S[q] + ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q])))))) ** 0.25
                            bayesian_19_5 = ((1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) + rdm.random() + OVER_19_5_S[q] + ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q])))))) ** 0.25
                            ...
                            bayesian_sh1_3_5 = ((1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) + rdm.random() + OVER_sh1_3_5_S[q] + ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q])))))) ** 0.25
                            ...
                            bayesian_sh2_3_5 = ((1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) + rdm.random() + OVER_sh2_3_5_S[q] + ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q])))))) ** 0.25
                        ...
                        if Z == COMBINERS[7]:
                            ...
                            bayesian_15_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_15_5s[q]))) * rdm.random() * OVER_15_5_S[q] * ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) / ((prob_15_5s[q] * (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) + ((1 - (prob_15_5_H_indps[q] * prob_15_5_A_indps[q])) * (1 - prob_15_5s[q]))))) ** 0.25
                            bayesian_17_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_17_5s[q]))) * rdm.random() * OVER_17_5_S[q] * ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) / ((prob_17_5s[q] * (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) + ((1 - (prob_17_5_H_indps[q] * prob_17_5_A_indps[q])) * (1 - prob_17_5s[q]))))) ** 0.25
                            bayesian_19_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_19_5s[q]))) * rdm.random() * OVER_19_5_S[q] * ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) / ((prob_19_5s[q] * (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) + ((1 - (prob_19_5_H_indps[q] * prob_19_5_A_indps[q])) * (1 - prob_19_5s[q]))))) ** 0.25
                            ...
                            bayesian_sh1_3_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh1_3_5s[q]))) * rdm.random() * OVER_sh1_3_5_S[q] * ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) / ((prob_sh1_3_5s[q] * (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) + ((1 - (prob_sh1_3_5_H_indps[q] * prob_sh1_3_5_A_indps[q])) * (1 - prob_sh1_3_5s[q]))))) ** 0.25
                            ...
                            bayesian_sh2_3_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_sh2_3_5s[q]))) * rdm.random() * OVER_sh2_3_5_S[q] * ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) / ((prob_sh2_3_5s[q] * (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) + ((1 - (prob_sh2_3_5_H_indps[q] * prob_sh2_3_5_A_indps[q])) * (1 - prob_sh2_3_5s[q]))))) ** 0.25
        ...
        with open(f"../LISTS - SPORTS DATA/SPORTS_DATA_LIST_{sport}.txt", mode="a") as file:
            try:
                file.write(f"countries = {countries}\nleagues = {leagues}\nhome_teams = {home_teams}\n"
                           ...
                           f"h_form_W = {h_form_W}\nh_form_D = {h_form_D}\nh_form_L = {h_form_L}\n"
                           f"a_form_W = {a_form_W}\na_form_D = {a_form_D}\na_form_L = {a_form_L}\n"
                           f"prob_15_5s = {prob_15_5s}\nprob_17_5s = {prob_17_5s}\nprob_19_5s = {prob_19_5s}\n"
                           f"prob_sh1_2_5s = {prob_sh1_2_5s}\nprob_sh1_3_5s = {prob_sh1_3_5s}\n"
                           f"prob_sh2_2_5s = {prob_sh2_2_5s}\nprob_sh2_3_5s = {prob_sh2_3_5s}\n"
                           f"prob_12s = {prob_12s}\nprob_HWs = {prob_HWs}\nprob_AWs = {prob_AWs}\n"
                           f"prob_15_5_H_indps = {prob_15_5_H_indps}\nprob_17_5_H_indps = {prob_17_5_H_indps}\nprob_19_5_H_indps = {prob_19_5_H_indps}\n"
                           f"prob_sh1_2_5_H_indps = {prob_sh1_2_5_H_indps}\nprob_sh1_3_5_H_indps = {prob_sh1_3_5_H_indps}\n"
                           f"prob_sh2_2_5_H_indps = {prob_sh2_2_5_H_indps}\nprob_sh2_3_5_H_indps = {prob_sh2_3_5_H_indps}\n"
                           f"prob_12_H_indps = {prob_12_H_indps}\n"
                           f"prob_HW_H_indps = {prob_HW_H_indps}\nprob_AW_H_indps = {prob_AW_H_indps}\n"
                           f"prob_15_5_A_indps = {prob_15_5_A_indps}\nprob_17_5_A_indps = {prob_17_5_A_indps}\nprob_19_5_A_indps = {prob_19_5_A_indps}\n"
                           f"prob_sh1_2_5_A_indps = {prob_sh1_2_5_A_indps}\nprob_sh1_3_5_A_indps = {prob_sh1_3_5_A_indps}\n"
                           f"prob_sh2_2_5_A_indps = {prob_sh2_2_5_A_indps}\nprob_sh2_3_5_A_indps = {prob_sh2_3_5_A_indps}\n"
                           ...
                           f"sport = {sport}\n_1HWS = {_1HWS}\n_2AWS = {_2AWS}\nOVER_15_5_S = {OVER_15_5_S}\n"
                           f"OVER_17_5_S = {OVER_17_5_S}\nOVER_19_5_S = {OVER_19_5_S}\n"
                           f"OVER_sh1_2_5_S = {OVER_sh1_2_5_S}\nOVER_sh1_3_5_S = {OVER_sh1_3_5_S}\n"
                           f"OVER_sh2_2_5_S = {OVER_sh2_2_5_S}\nOVER_sh2_3_5_S = {OVER_sh2_3_5_S}\n"
