...
OUTCOMES = ["HW", "AW", "ov3.5", "ov4.5", "sh1_1.5", "sh1_2.5", "sh2_1.5", "sh2_2.5", "12"]
...
def h2h_prob_calc():
    ...
    if prob_AW == 0:
        prob_AW += 0.01
    return [prob_HW, prob_AW, prob_3_5i, prob_4_5i, prob_sh1_1_5i, prob_sh1_2_5i, prob_sh2_1_5i, prob_sh2_2_5i, prob_12i]


def h2h_appender(prb_HW, prb_AW, prb_3_5, prb_4_5, prb_sh1_1_5, prb_sh1_2_5, prb_sh2_1_5, prb_sh2_2_5, prb_12):
...
def ht_indp_prob_calc():
    ...
    if prob_AW_H_indp == 0:
        prob_AW_H_indp += 0.01
    return [prob_HW_H_indp, prob_AW_H_indp, prob_3_5_H_indp, prob_4_5_H_indp, prob_sh1_1_5_H_indp,
            prob_sh1_2_5_H_indp, prob_sh2_1_5_H_indp, prob_sh2_2_5_H_indp, prob_12_H_indp]


def ht_indp_appender(prb_HW_H_indp, prb_AW_H_indp, prb_3_5_H_indp, prb_4_5_H_indp, prb_sh1_1_5_H_indp,
...
def at_indp_prob_calc():
    ...
    if prob_AW_A_indp == 0:
        prob_AW_A_indp += 0.01
    return [prob_HW_A_indp, prob_AW_A_indp, prob_3_5_A_indp, prob_4_5_A_indp, prob_sh1_1_5_A_indp,
            prob_sh1_2_5_A_indp, prob_sh2_1_5_A_indp, prob_sh2_2_5_A_indp, prob_12_A_indp]


def at_indp_appender(prb_HW_A_indp, prb_AW_A_indp, prb_3_5_A_indp, prb_4_5_A_indp, prb_sh1_1_5_A_indp,
    ...
    try:
        ...
        try:
            ...
            for z in range(len(ahl)):
                try:
                    id_4_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({z + 1}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_4_5 == "4.5":
                        OVER_4_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({z + 1}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
...
def baye_appender(baye_HW, baye_AW, baye_3_5, baye_4_5, baye_sh1_1_5, baye_sh1_2_5, baye_sh2_1_5,
...
def total_aggregator():
    ...
    try:
        ...
        if len(sub1) == 0:
            ht_indp_appender(prb_HW_H_indp=0.01, prb_AW_H_indp=0.01, prb_3_5_H_indp=0.01,
                             prb_4_5_H_indp=0.01, prb_sh1_1_5_H_indp=0.01, prb_sh1_2_5_H_indp=0.01,
            ...
            if dsc >= DSCRM_H_A:
                try:
                    ...
                    ht_indp_appender(prb_HW_H_indp=ht_indp_values[0], prb_AW_H_indp=ht_indp_values[1],
                                     prb_3_5_H_indp=ht_indp_values[2],
                                     prb_4_5_H_indp=ht_indp_values[3], prb_sh1_1_5_H_indp=ht_indp_values[4],
                                     prb_sh1_2_5_H_indp=ht_indp_values[5], prb_sh2_1_5_H_indp=ht_indp_values[6],
                                     prb_sh2_2_5_H_indp=ht_indp_values[7], prb_12_H_indp=ht_indp_values[8])
                except ZeroDivisionError:
                    ht_indp_appender(prb_HW_H_indp=0.01, prb_AW_H_indp=0.01, prb_3_5_H_indp=0.01,
                                     prb_4_5_H_indp=0.01, prb_sh1_1_5_H_indp=0.01, prb_sh1_2_5_H_indp=0.01,
                                     prb_sh2_1_5_H_indp=0.01, prb_sh2_2_5_H_indp=0.01, prb_12_H_indp=0.99)
    ...
    try:
        ...
        if len(sub2) == 0:
            at_indp_appender(prb_HW_A_indp=0.01, prb_AW_A_indp=0.01, prb_3_5_A_indp=0.01,
                             prb_4_5_A_indp=0.01, prb_sh1_1_5_A_indp=0.01, prb_sh1_2_5_A_indp=0.01,
            ...
            if dsc >= DSCRM_H_A:
                try:
                    ...
                    at_indp_appender(prb_HW_A_indp=at_indp_values[0], prb_AW_A_indp=at_indp_values[1],
                                     prb_3_5_A_indp=at_indp_values[2],
                                     prb_4_5_A_indp=at_indp_values[3], prb_sh1_1_5_A_indp=at_indp_values[4],
                                     prb_sh1_2_5_A_indp=at_indp_values[5], prb_sh2_1_5_A_indp=at_indp_values[6],
                                     prb_sh2_2_5_A_indp=at_indp_values[7], prb_12_A_indp=at_indp_values[8])
                except ZeroDivisionError:
                    at_indp_appender(prb_HW_A_indp=0.01, prb_AW_A_indp=0.01, prb_3_5_A_indp=0.01,
                                     prb_4_5_A_indp=0.01, prb_sh1_1_5_A_indp=0.01, prb_sh1_2_5_A_indp=0.01,
                                     prb_sh2_1_5_A_indp=0.01, prb_sh2_2_5_A_indp=0.01, prb_12_A_indp=0.99)
    ...
    try:
        ...
        if len(sub3) == 0:
            h2h_appender(prb_HW=0.01, prb_AW=0.01, prb_3_5=0.01, prb_4_5=0.01, prb_sh1_1_5=0.01,
            ...
            if dsc >= DSCRM_BT:
                try:
                    ...
                    h2h_appender(prb_HW=h2h_values[0], prb_AW=h2h_values[1], prb_3_5=h2h_values[2],
                                 prb_4_5=h2h_values[3], prb_sh1_1_5=h2h_values[4], prb_sh1_2_5=h2h_values[5],
                                 prb_sh2_1_5=h2h_values[6], prb_sh2_2_5=h2h_values[7], prb_12=h2h_values[8])
                except ZeroDivisionError:
                    h2h_appender(prb_HW=0.01, prb_AW=0.01, prb_3_5=0.01, prb_4_5=0.01, prb_sh1_1_5=0.01,
                                 prb_sh1_2_5=0.01, prb_sh2_1_5=0.01, prb_sh2_2_5=0.01, prb_12=0.01)
            else:
...
def print_all_data():
    ...
    print(f"Prob 4_5s: {prob_4_5s}")
    print(f"Prob 5_5s: {prob_sh1_1_5s}")
    print(f"Prob 12s: {prob_12s}")
    print(f"Prob HWs: {prob_HWs}")
    print(f"Prob AWs: {prob_AWs}")
    print(f"Prob 3_5_H_indps: {prob_3_5_H_indps}")
    print(f"Prob 4_5_H_indps: {prob_4_5_H_indps}")
    print(f"Prob 5_5_H_indps: {prob_sh1_1_5_H_indps}")
    ...
    print(f"Prob 4_5_A_indps: {prob_4_5_A_indps}")
    print(f"Prob 5_5_A_indps: {prob_sh1_1_5_A_indps}")
    ...
    print(f"Bayesian 3.5: {bayesian_3_5_d}")
    print(f"Bayesian 4.5: {bayesian_4_5_d}")
    ...
    print(f"Countries: {len(countries)}, Leagues: {len(leagues)}, Home Teams: {len(home_teams)}, "
          ...
          f"Prob 3_5s: {len(prob_3_5s)} Prob 4_5s: {len(prob_4_5s)}, Prob 5_5s: {len(prob_sh1_1_5s)},"
          f"Prob 12s: {len(prob_12s)}, Prob HWs: {len(prob_HWs)}, Prob AWs: {len(prob_AWs)}, "
          f"Prob 3_5_H_indps: {len(prob_3_5_H_indps)}, Prob 4_5_H_indps: {len(prob_4_5_H_indps)}, "
          ...
          f"Prob 3_5_A_indps: {len(prob_3_5_A_indps)}, Prob 4_5_A_indps: {len(prob_4_5_A_indps)}, "
          ...
          f"Odds OVER_4_5_S: {len(OVER_4_5_S)}, Odds OVER_sh1_1_5_S: {len(OVER_sh1_1_5_S)}, Odds _12S: {len(_12S)}"
          f"Bayesian Home Win: {len(bayesian_home_Win_d)}, Bayesian Away Win: {len(bayesian_away_Win_d)}, "
          f"Bayesian 3.5: {len(bayesian_3_5_d)}, Bayesian 4.5: {len(bayesian_4_5_d)}, "
          f"Bayesian 5.5: {len(bayesian_sh1_1_5_d)}, Bayesian 12: {len(bayesian_12_d) }")
    ...
    for COMBINER in COMBINERS[:4]:
        ...
        for COMB in COMB_PROB_METRICS1:
            ...
            for q in range(len(home_teams)):
                try:
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[0]:
                        ...
                        baye_appender(baye_HW=bayesian_home_Win, baye_AW=bayesian_away_Win, baye_3_5=bayesian_3_5, baye_4_5=bayesian_4_5, baye_sh1_1_5=bayesian_sh1_1_5, baye_sh1_2_5=bayesian_sh1_2_5, baye_sh2_1_5=bayesian_sh2_1_5, baye_sh2_2_5=bayesian_sh2_2_5, baye_12=bayesian_12)
            ...
            for q in range(len(bayesian_home_Win_d)):
                ...
                try:
                    if bayesian_3_5_d[q] > CONFINTVL or bayesian_4_5_d[q] > CONFINTVL or bayesian_sh1_1_5_d[q] > CONFINTVL or bayesian_sh2_1_5_d[q] > CONFINTVL:
                            ...
                            if h_form_D[q] == 0 and a_form_D[q] == 0:
                                if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                    if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                        if bayesian_4_5_d[q] <= bayesian_3_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF:
                                        ...
                                        if bayesian_4_5_d[q] <= bayesian_3_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and BAY_DIFF <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= bayesian_12_d[q] and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                            with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                writer(w=q, A=X, B=Y, C=Z, data=file)
                        ...
                        if home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP:
                            if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                    ...
                                    if bayesian_4_5_d[q] <= bayesian_3_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                        if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                            with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                writer(w=q, A=X, B=Y, C=Z, data=file)
                                ...
                                if h_form_D[q] == 0 and a_form_D[q] == 0:
                                    if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                        if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                            if bayesian_4_5_d[q] <= bayesian_3_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2):
                                                if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                    with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                        writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                                        else:
                                            if bayesian_4_5_d[q] <= bayesian_3_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (BAY_DIFF / 2) <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= (0.5 * bayesian_12_d[q]):
                                                with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                    writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                            ...
                            if home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP:
                                if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                    if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                        ...
                                        if bayesian_4_5_d[q] <= bayesian_3_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2) and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                            if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                    writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
