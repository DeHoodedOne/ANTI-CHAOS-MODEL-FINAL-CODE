...
OUTCOMES = ["HW", "AW", "ov8.5", "ov9.5", "ov10.5", "sh1_1.5", "sh1_2.5", "sh2_1.5", "sh2_2.5", "12"]

start_time = time.time()
SPORT_ = master_sport_list()[0][13]
...
def h2h_aggregator(m, home_score, away_score, home_x, away_x):
    ...
    if (int(home_score[m].text) + int(away_score[m].text)) >= 9:
        count_8_5 += 1
    if (int(home_score[m].text) + int(away_score[m].text)) >= 10:
        count_9_5 += 1
...
def h2h_prob_calc():
    ...
    prob_9_5i = float(count_9_5 / valid_games)
    prob_10_5i = float(count_10_5 / valid_games)
    ...
    if prob_AW == 0:
        prob_AW += 0.01
    return [prob_HW, prob_AW, prob_8_5i, prob_9_5i, prob_10_5i, prob_sh1_1_5i, prob_sh1_2_5i, prob_sh2_1_5i, prob_sh2_2_5i, prob_12i]


def h2h_appender(prb_HW, prb_AW, prb_8_5, prb_9_5, prb_10_5, prb_sh1_1_5, prb_sh1_2_5, prb_sh2_1_5, prb_sh2_2_5, prb_12):
    prob_HWs.append(prb_HW)
    prob_AWs.append(prb_AW)
    prob_8_5s.append(prb_8_5)
    prob_9_5s.append(prb_9_5)
...
def ht_indp_aggregator(k, home_score, away_score, home_x, away_x):
    ...
    global count_9_5_H_indp
    global count_10_5_H_indp
    ...
    if (int(home_score[k].text) + int(away_score[k].text)) >= 9 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 6:
        count_8_5_H_indp += 1
    if (int(home_score[k].text) + int(away_score[k].text)) >= 10 and (home_x[k].text == home_teamx) and int(home_score[k].text) >= 7:
        count_9_5_H_indp += 1
    if (int(home_score[k].text) + int(away_score[k].text)) >= 10 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 7:
        count_9_5_H_indp += 1
...
def ht_indp_prob_calc():
    ...
    prob_9_5_H_indp = float(count_9_5_H_indp / valid_games_H_indp)
    prob_10_5_H_indp = float(count_10_5_H_indp / valid_games_H_indp)
    ...
    if prob_9_5_H_indp == 1.0:
        prob_9_5_H_indp -= 0.01
    if prob_10_5_H_indp == 1.0:
        prob_10_5_H_indp -= 0.01
    ...
    if prob_8_5_H_indp == 0:
        prob_8_5_H_indp += 0.01
    if prob_9_5_H_indp == 0:
        prob_9_5_H_indp += 0.01
    if prob_10_5_H_indp == 0:
        prob_10_5_H_indp += 0.01
    ...
    if prob_AW_H_indp == 0:
        prob_AW_H_indp += 0.01
    return [prob_HW_H_indp, prob_AW_H_indp, prob_8_5_H_indp, prob_9_5_H_indp, prob_10_5_H_indp, prob_sh1_1_5_H_indp,
            prob_sh1_2_5_H_indp, prob_sh2_1_5_H_indp, prob_sh2_2_5_H_indp, prob_12_H_indp]


def ht_indp_appender(prb_HW_H_indp, prb_AW_H_indp, prb_8_5_H_indp, prb_9_5_H_indp, prb_10_5_H_indp, prb_sh1_1_5_H_indp,
    ...
    prob_9_5_H_indps.append(prb_9_5_H_indp)
...
def at_indp_aggregator(n, home_score, away_score, home_x, away_x):
    ...
    global count_9_5_A_indp
    global count_10_5_A_indp
    ...
    if (int(home_score[n].text) + int(away_score[n].text)) >= 9 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 6:
        count_8_5_A_indp += 1
    if (int(home_score[n].text) + int(away_score[n].text)) >= 10 and (home_x[n].text == away_teamx) and int(home_score[n].text) >= 7:
        count_9_5_A_indp += 1
    if (int(home_score[n].text) + int(away_score[n].text)) >= 10 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 7:
        count_9_5_A_indp += 1
...
def at_indp_prob_calc():
    ...
    prob_9_5_A_indp = float(count_9_5_A_indp / valid_games_A_indp)
    prob_10_5_A_indp = float(count_10_5_A_indp / valid_games_A_indp)
    ...
    if prob_9_5_A_indp == 1.0:
        prob_9_5_A_indp -= 0.01
    if prob_10_5_A_indp == 1.0:
        prob_10_5_A_indp -= 0.01
    ...
    if prob_8_5_A_indp == 0:
        prob_8_5_A_indp += 0.01
    if prob_9_5_A_indp == 0:
        prob_9_5_A_indp += 0.01
    if prob_10_5_A_indp == 0:
        prob_10_5_A_indp += 0.01
    ...
    if prob_AW_A_indp == 0:
        prob_AW_A_indp += 0.01
    return [prob_HW_A_indp, prob_AW_A_indp, prob_8_5_A_indp, prob_9_5_A_indp, prob_10_5_A_indp, prob_sh1_1_5_A_indp,
            prob_sh1_2_5_A_indp, prob_sh2_1_5_A_indp, prob_sh2_2_5_A_indp, prob_12_A_indp]


def at_indp_appender(prb_HW_A_indp, prb_AW_A_indp, prb_8_5_A_indp, prb_9_5_A_indp, prb_10_5_A_indp, prb_sh1_1_5_A_indp,
    ...
    prob_9_5_A_indps.append(prb_9_5_A_indp)
...
def odds_checker():
    try:
        ...
        try:
            ...
            for x in range(len(ahl)):
                try:
                    id_9_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x + 1}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_9_5 == "9.5":
                        OVER_9_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x + 1}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
                        OVER_9_5_S.append(1 / float(OVER_9_5))
                        break
                    if x == (len(ahl) - 1):
                        OVER_9_5_S.append(0.5)
                except NoSuchElementException:
                    continue
                except IndexError:
                    OVER_9_5_S.append(0.5)
...
def writer(w, A, B, C, data):
    data.write(f"{countries[w]}|{leagues[w]}|{home_teams[w]}|{away_teams[w]}|{home_positions[w]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_8_5_d[w]}|{OUTCOMES[3]}:-{bayesian_9_5_d[w]}|"
...
def writer1(y, F, G, H, J, data):
    data.write(f"{countries[y]}|{leagues[y]}|{home_teams[y]}|{away_teams[y]}|{home_positions[y]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_8_5_d[y]}|{OUTCOMES[3]}:-{bayesian_9_5_d[y]}|"
...
def writer2(z, K, L, M, N, P, data):
    data.write(f"{countries[z]}|{leagues[z]}|{home_teams[z]}|{away_teams[z]}|{home_positions[z]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_8_5_d[z]}|{OUTCOMES[3]}:-{bayesian_9_5_d[z]}|"
...
def baye_appender(baye_HW, baye_AW, baye_8_5, baye_9_5, baye_10_5, baye_sh1_1_5, baye_sh1_2_5, baye_sh2_1_5,
    ...
    bayesian_9_5_d.append(round((float(baye_9_5)), 4))
...
def total_aggregator():
    ...
    try:
        ...
        if len(sub1) == 0:
            ht_indp_appender(prb_HW_H_indp=0.01, prb_AW_H_indp=0.01, prb_8_5_H_indp=0.01, prb_9_5_H_indp=0.01,
                             prb_10_5_H_indp=0.01, prb_sh1_1_5_H_indp=0.01, prb_sh1_2_5_H_indp=0.01,
            ...
            if dsc >= DSCRM_H_A:
                try:
                    ...
                    ht_indp_appender(prb_HW_H_indp=ht_indp_values[0], prb_AW_H_indp=ht_indp_values[1],
                                     prb_8_5_H_indp=ht_indp_values[2], prb_9_5_H_indp=ht_indp_values[3],
    ...
    try:
        ...
        if len(sub2) == 0:
            at_indp_appender(prb_HW_A_indp=0.01, prb_AW_A_indp=0.01, prb_8_5_A_indp=0.01, prb_9_5_A_indp=0.01,
                             prb_10_5_A_indp=0.01, prb_sh1_1_5_A_indp=0.01, prb_sh1_2_5_A_indp=0.01,
            ...
            if dsc >= DSCRM_H_A:
                try:
                    ...
                    at_indp_appender(prb_HW_A_indp=at_indp_values[0], prb_AW_A_indp=at_indp_values[1],
                                     prb_8_5_A_indp=at_indp_values[2], prb_9_5_A_indp=at_indp_values[3],
    ...
    try:
        ...
        if len(sub3) == 0:
            h2h_appender(prb_HW=0.01, prb_AW=0.01, prb_8_5=0.01, prb_9_5=0.01, prb_10_5=0.01, prb_sh1_1_5=0.01,
            ...
            if dsc >= DSCRM_BT:
                try:
                    ...
                    h2h_appender(prb_HW=h2h_values[0], prb_AW=h2h_values[1], prb_8_5=h2h_values[2], prb_9_5=h2h_values[3],
...
def print_all_data():
    ...
    print(f"Prob 9_5s: {prob_9_5s}")
    print(f"Prob 10_5s: {prob_10_5s}")
    print(f"Prob sh1_1_9_5s: {prob_sh1_1_5s}")
    print(f"Prob sh1_2_9_5s: {prob_sh1_2_5s}")
    print(f"Prob sh2_1_9_5s: {prob_sh2_1_5s}")
    print(f"Prob sh2_2_9_5s: {prob_sh2_2_5s}")
    print(f"Prob 12s: {prob_12s}")
    print(f"Prob HWs: {prob_HWs}")
    print(f"Prob AWs: {prob_AWs}")
    print(f"Prob 8_5_H_indps: {prob_8_5_H_indps}")
    print(f"Prob 9_5_H_indps: {prob_9_5_H_indps}")
    print(f"Prob 10_5_H_indps: {prob_10_5_H_indps}")
    ...
    print(f"Prob 9_5_A_indps: {prob_9_5_A_indps}")
    print(f"Prob 10_5_A_indps: {prob_10_5_A_indps}")
    ...
    print(f"Bayesian 8.5: {bayesian_8_5_d}")
    print(f"Bayesian 9.5: {bayesian_9_5_d}")
    print(f"Bayesian 10.5: {bayesian_10_5_d}")
    ...
    print(f"Odds OVER_9_5_S: {OVER_9_5_S}")
    print(f"Odds OVER_10_5_S: {OVER_10_5_S}")
    ...
    print(f"Countries: {len(countries)}, Leagues: {len(leagues)}, Home Teams: {len(home_teams)}, "
          ...
          f"Prob 8_5s: {len(prob_8_5s)}, Prob 9_5s: {len(prob_9_5s)} Prob 10_5s: {len(prob_10_5s)}, Prob 9_5s: {len(prob_sh1_1_5s)},"
          f"Prob 12s: {len(prob_12s)}, Prob HWs: {len(prob_HWs)}, Prob AWs: {len(prob_AWs)}, "
          f"Prob 8_5_H_indps: {len(prob_8_5_H_indps)}, Prob 9_5_H_indps: {len(prob_9_5_H_indps)}, Prob 10_5_H_indps: {len(prob_10_5_H_indps)}, "
          f"Prob 9_5_H_indps: {len(prob_sh1_1_5_H_indps)}, Prob 12_H_indps: {len(prob_12_H_indps)},"
          f"Prob HW_H_indps: {len(prob_HW_H_indps)}, Prob AW_H_indps: {len(prob_AW_H_indps)}, "
          f"Prob 8_5_A_indps: {len(prob_8_5_A_indps)}, Prob 9_5_A_indps: {len(prob_9_5_A_indps)}, Prob 10_5_A_indps: {len(prob_10_5_A_indps)}, "
          ...
          f"Odds _1HWS: {len(_1HWS)}, Odds _2AWS: {len(_2AWS)}, Odds OVER_8_5_S: {len(OVER_9_5_S)},  Odds OVER_9_5_S: {len(OVER_9_5_S)}, "
          ...
          f"Bayesian 8_5: {len(bayesian_8_5_d)}, Bayesian 5.5: {len(bayesian_9_5_d)}, Bayesian 6.5: {len(bayesian_10_5_d)}, "
    ...
    for COMBINER in COMBINERS[:4]:
        ...
        for COMB in COMB_PROB_METRICS1:
            ...
            for q in range(len(home_teams)):
                try:
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[0]:
                        ...
                        bayesian_9_5 = 0.5 * (rdm.random() + ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q])))))
                        ...
                        baye_appender(baye_HW=bayesian_home_Win, baye_AW=bayesian_away_Win, baye_8_5=bayesian_8_5, baye_9_5=bayesian_9_5, baye_10_5=bayesian_10_5, baye_sh1_1_5=bayesian_sh1_1_5, baye_sh1_2_5=bayesian_sh1_2_5, baye_sh2_1_5=bayesian_sh2_1_5, baye_sh2_2_5=bayesian_sh2_2_5, baye_12=bayesian_12)
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[0]:
                        ...
                        bayesian_9_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) + ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q])))))
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                        ...
                        bayesian_9_5 = 0.5 * (OVER_9_5_S[q] + ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q])))))
                    ...
                    if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[0]:
                        ...
                        bayesian_9_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) + rdm.random())
                    ...
                    if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                        ...
                        bayesian_9_5 = 0.5 * (OVER_9_5_S[q] + rdm.random())
                    ...
                    if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                        ...
                        bayesian_9_5 = 0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) + OVER_9_5_S[q])
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[1]:
                        ...
                        bayesian_9_5 = rdm.random() * ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q]))))
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[1]:
                        ...
                        bayesian_9_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q]))))
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                        ...
                        bayesian_9_5 = OVER_9_5_S[q] * ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q]))))
                    ...
                    if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[1]:
                        ...
                        bayesian_9_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * rdm.random()
                    ...
                    if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                        ...
                        bayesian_9_5 = OVER_9_5_S[q] * rdm.random()
                    ...
                    if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                        ...
                        bayesian_9_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * OVER_9_5_S[q]
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[2]:
                        ...
                        bayesian_9_5 = math.sqrt(0.5 * (rdm.random() + ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q]))))))
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[2]:
                        ...
                        bayesian_9_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) + ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q]))))))
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[2]:
                        ...
                        bayesian_9_5 = math.sqrt(0.5 * (OVER_9_5_S[q] + ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q]))))))
                    ...
                    if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[2]:
                        ...
                        bayesian_9_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) + rdm.random()))
                    ...
                    if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[2]:
                        ...
                        bayesian_9_5 = math.sqrt(0.5 * (OVER_9_5_S[q] + rdm.random()))
                    ...
                    if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[2]:
                        ...
                        bayesian_9_5 = math.sqrt(0.5 * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) + OVER_9_5_S[q]))
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[3]:
                        ...
                        bayesian_9_5 = math.sqrt(rdm.random() * ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q])))))
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[2] and Z == COMBINERS[3]:
                        ...
                        bayesian_9_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q])))))
                    ...
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[3] and Z == COMBINERS[3]:
                        ...
                        bayesian_9_5 = math.sqrt(OVER_9_5_S[q] * ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q])))))
                    ...
                    if X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[3]:
                        ...
                        bayesian_9_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * rdm.random())
                    ...
                    if X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[3]:
                        ...
                        bayesian_9_5 = math.sqrt(OVER_9_5_S[q] * rdm.random())
                    ...
                    if X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[3]:
                        ...
                        bayesian_9_5 = math.sqrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * OVER_9_5_S[q])
            ...
            for q in range(len(bayesian_home_Win_d)):
                ...
                try:
                    if bayesian_9_5_d[q] > CONFINTVL or bayesian_10_5_d[q] > CONFINTVL or bayesian_sh1_1_5_d[q] > CONFINTVL or bayesian_sh2_1_5_d[q] > CONFINTVL:
                            ...
                            if h_form_D[q] == 0 and a_form_D[q] == 0:
                                if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                    if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                        if bayesian_10_5_d[q] <= bayesian_9_5_d[q] <= bayesian_8_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF:
                                        ...
                                        if bayesian_10_5_d[q] <= bayesian_9_5_d[q] <= bayesian_8_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and BAY_DIFF <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= bayesian_12_d[q] and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                            with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                writer(w=q, A=X, B=Y, C=Z, data=file)
                        ...
                        if home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP:
                            if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                    ...
                                    if bayesian_10_5_d[q] <= bayesian_9_5_d[q] <= bayesian_8_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                        if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                            with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                writer(w=q, A=X, B=Y, C=Z, data=file)
        ...
        for q in range(len(home_teams)):
            try:
                if X == PROB_METRICS[0]:
                    ...
                    bayesian_9_5 = (prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q])))
                ...
                if X == PROB_METRICS[1]:
                    ...
                    prob_9_5 = rdm.random()
                    prob_9_5_indp_home = rdm.random()
                    prob_9_5_indp_away = rdm.random()
                    bayesian_9_5 = (prob_9_5 * (prob_9_5_indp_home * prob_9_5_indp_away)) / ((prob_9_5 * (prob_9_5_indp_home * prob_9_5_indp_away)) + ((1 - (prob_9_5_indp_home * prob_9_5_indp_away)) * (1 - prob_9_5)))
                ...
                if X == PROB_METRICS[2]:
                    ...
                    bayesian_9_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))
                ...
                if X == PROB_METRICS[4]:
                    ...
                    bayesian_9_5 = math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q])) * diff_z_prob[q]
        ...
        for q in range(len(home_teams)):
            try:
                if X == PROB_METRICS1[0] and Y == PROB_METRICS1[1]:
                    ...
                    prob_9_5_indp_home = rdm.random()
                    prob_9_5_indp_away = rdm.random()
                    bayesian_9_5 = (prob_9_5s[q] * (prob_9_5_indp_home * prob_9_5_indp_away)) / ((prob_9_5s[q] * (prob_9_5_indp_home * prob_9_5_indp_away)) + ((1 - (prob_9_5_indp_home * prob_9_5_indp_away)) * (1 - prob_9_5s[q])))
                    prob_10_5_indp_home = rdm.random()
                    prob_10_5_indp_away = rdm.random()
                ...
                if X == PROB_METRICS1[0] and Y == PROB_METRICS1[2]:
                    ...
                    prob_9_5_indp_home = rdm.random()
                    prob_9_5_indp_away = rdm.random()
                    bayesian_9_5 = (((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * (prob_9_5_indp_home * prob_9_5_indp_away)) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * (prob_9_5_indp_home * prob_9_5_indp_away)) + ((1 - (prob_9_5_indp_home * prob_9_5_indp_away)) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q])))))))
                    prob_10_5_indp_home = rdm.random()
                    prob_10_5_indp_away = rdm.random()
                ...
                if X == PROB_METRICS1[0] and Y == PROB_METRICS1[3]:
                    ...
                    prob_9_5_indp_home = rdm.random()
                    prob_9_5_indp_away = rdm.random()
                    bayesian_9_5 = (OVER_9_5_S[q] * (prob_9_5_indp_home * prob_9_5_indp_away)) / ((OVER_9_5_S[q] * (prob_9_5_indp_home * prob_9_5_indp_away)) + ((1 - (prob_9_5_indp_home * prob_9_5_indp_away)) * (1 - OVER_9_5_S[q])))
                    prob_10_5_indp_home = rdm.random()
                    prob_10_5_indp_away = rdm.random()
                ...
                if X == PROB_METRICS1[1] and Y == PROB_METRICS1[0]:
                    ...
                    prob_9_5 = rdm.random()
                    bayesian_9_5 = ((prob_9_5 * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5 * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5))))
                    prob_10_5 = rdm.random()
                ...
                if X == PROB_METRICS1[1] and Y == PROB_METRICS1[2]:
                    ...
                    bayesian_9_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / (((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - (math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))))))
                ...
                if X == PROB_METRICS1[1] and Y == PROB_METRICS1[3]:
                    ...
                    bayesian_9_5 = (OVER_9_5_S[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((OVER_9_5_S[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - OVER_9_5_S[q])))
                ...
                for q in range(len(home_teams)):
                    try:
                        if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[0]:
                            ...
                            bayesian_9_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) + rdm.random() + ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q])))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[1]:
                            ...
                            bayesian_9_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * rdm.random() * ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q]))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[2] and Z == COMBINERS[4]:
                            ...
                            bayesian_9_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) + rdm.random() + ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q]))))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                            ...
                            bayesian_9_5 = (1 / 3) * (OVER_9_5_S[q] + rdm.random() + ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q])))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                            ...
                            bayesian_9_5 = OVER_9_5_S[q] * rdm.random() * ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q]))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[4]:
                            ...
                            bayesian_9_5 = np.cbrt((1 / 3) * (OVER_9_5_S[q] + rdm.random() + ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q]))))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[1] and Y == PROB_METRICS[3] and Z == COMBINERS[5]:
                            ...
                            bayesian_9_5 = np.cbrt(OVER_9_5_S[q] * rdm.random() * ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q])))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                            ...
                            bayesian_9_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) + OVER_9_5_S[q] + ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q])))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                            ...
                            bayesian_9_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * OVER_9_5_S[q] * ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q]))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[4]:
                            ...
                            bayesian_9_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) + OVER_9_5_S[q] + ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q]))))))
                        ...
                        if W == PROB_METRICS[0] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[5]:
                            ...
                            bayesian_9_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * OVER_9_5_S[q] * ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q])))))
                        ...
                        if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[0]:
                            ...
                            bayesian_9_5 = (1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) + rdm.random() + OVER_9_5_S[q])
                        ...
                        if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[1]:
                            ...
                            bayesian_9_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * rdm.random() * OVER_9_5_S[q]
                        ...
                        if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[4]:
                            ...
                            bayesian_9_5 = np.cbrt((1 / 3) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) + rdm.random() + OVER_9_5_S[q]))
                        ...
                        if W == PROB_METRICS[1] and X == PROB_METRICS[2] and Y == PROB_METRICS[3] and Z == COMBINERS[5]:
                            ...
                            bayesian_9_5 = np.cbrt((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * rdm.random() * OVER_9_5_S[q])
                                ...
                                if h_form_D[q] == 0 and a_form_D[q] == 0:
                                    if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                        if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                            if bayesian_10_5_d[q] <= bayesian_9_5_d[q] <= bayesian_8_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2):
                                                if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                    with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                        writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                                        else:
                                            if bayesian_10_5_d[q] <= bayesian_9_5_d[q] <= bayesian_8_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (BAY_DIFF / 2) <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= (0.5 * bayesian_12_d[q]):
                                                with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                    writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                            ...
                            if home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP:
                                if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                    if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                        ...
                                        if bayesian_10_5_d[q] <= bayesian_9_5_d[q] <= bayesian_8_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2) and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                            if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                    writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                ...
                for q in range(len(home_teams)):
                    try:
                        if Z == COMBINERS[0]:
                            ...
                            bayesian_9_5 = (1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) + rdm.random() + OVER_9_5_S[q] + ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q])))))
                        ...
                        if Z == COMBINERS[1]:
                            ...
                            bayesian_9_5 = (math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * rdm.random() * OVER_9_5_S[q] * ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q]))))
                        ...
                        if Z == COMBINERS[6]:
                            ...
                            bayesian_9_5 = ((1 / 4) * ((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) + rdm.random() + OVER_9_5_S[q] + ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q])))))) ** 0.25
                        ...
                        if Z == COMBINERS[7]:
                            ...
                            bayesian_9_5 = ((math.sqrt(0.5 * (diff_z_prob[q] + prob_9_5s[q]))) * rdm.random() * OVER_9_5_S[q] * ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) / ((prob_9_5s[q] * (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) + ((1 - (prob_9_5_H_indps[q] * prob_9_5_A_indps[q])) * (1 - prob_9_5s[q]))))) ** 0.25
        ...
        with open(f"../LISTS - SPORTS DATA/SPORTS_DATA_LIST_{sport}.txt", mode="a") as file:
            try:
                file.write(f"countries = {countries}\nleagues = {leagues}\nhome_teams = {home_teams}\n"
                           ...
                           f"prob_8_5_A_indps = {prob_8_5_A_indps}\nprob_9_5_A_indps = {prob_9_5_A_indps}\nprob_10_5_A_indps = {prob_10_5_A_indps}\n"
