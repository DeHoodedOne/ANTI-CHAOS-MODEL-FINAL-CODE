...
def h2h_prob_calc():
    ...
    if prob_AW == 0:
        prob_AW += 0.01
    return [prob_HW, prob_AW, prob_6_5i, prob_8_5i, prob_10_5i, prob_sh1_1_5i, prob_sh1_2_5i, prob_sh2_1_5i, prob_sh2_2_5i, prob_12i]


def h2h_appender(prb_HW, prb_AW, prb_6_5, prb_8_5, prb_10_5, prb_sh1_1_5, prb_sh1_2_5, prb_sh2_1_5, prb_sh2_2_5, prb_12):
...
def ht_indp_prob_calc():
    ...
    if prob_AW_H_indp == 0:
        prob_AW_H_indp += 0.01
    return [prob_HW_H_indp, prob_AW_H_indp, prob_6_5_H_indp, prob_8_5_H_indp, prob_10_5_H_indp, prob_sh1_1_5_H_indp,
...
def at_indp_prob_calc():
    ...
    if prob_AW_A_indp == 0:
        prob_AW_A_indp += 0.01
    return [prob_HW_A_indp, prob_AW_A_indp, prob_6_5_A_indp, prob_8_5_A_indp, prob_10_5_A_indp, prob_sh1_1_5_A_indp,
...
def total_aggregator():
    ...
    try:
        ...
        if len(sub1) == 0:
            ht_indp_appender(prb_HW_H_indp=0.01, prb_AW_H_indp=0.01, prb_6_5_H_indp=0.01, prb_8_5_H_indp=0.01,
    ...
    try:
        ...
        if len(sub2) == 0:
            at_indp_appender(prb_HW_A_indp=0.01, prb_AW_A_indp=0.01, prb_6_5_A_indp=0.01, prb_8_5_A_indp=0.01,
    ...
    try:
        ...
        if len(sub3) == 0:
            h2h_appender(prb_HW=0.01, prb_AW=0.01, prb_6_5=0.01, prb_8_5=0.01, prb_10_5=0.01, prb_sh1_1_5=0.01,
...
def print_all_data():
    ...
    print(f"Prob sh1_1_8_5s: {prob_sh1_1_5s}")
    print(f"Prob sh1_2_8_5s: {prob_sh1_2_5s}")
    print(f"Prob sh2_1_8_5s: {prob_sh2_1_5s}")
    print(f"Prob sh2_2_8_5s: {prob_sh2_2_5s}")
    ...
    print(f"Bayesian 4.5: {bayesian_6_5_d}")
    print(f"Bayesian 5.5: {bayesian_8_5_d}")
    print(f"Bayesian 6.5: {bayesian_10_5_d}")
    ...
    for COMBINER in COMBINERS[:4]:
        ...
        for COMB in COMB_PROB_METRICS1:
            ...
            for q in range(len(home_teams)):
                try:
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[0]:
                        ...
                        baye_appender(baye_HW=bayesian_home_Win, baye_AW=bayesian_away_Win, baye_6_5=bayesian_6_5, baye_8_5=bayesian_8_5, baye_10_5=bayesian_10_5, baye_sh1_1_5=bayesian_sh1_1_5, baye_sh1_2_5=bayesian_sh1_2_5, baye_sh2_1_5=bayesian_sh2_1_5, baye_sh2_2_5=bayesian_sh2_2_5, baye_12=bayesian_12)
            ...
            for q in range(len(bayesian_home_Win_d)):
                ...
                try:
                    if bayesian_6_5_d[q] > CONFINTVL or bayesian_8_5_d[q] > CONFINTVL or bayesian_10_5_d[q] > CONFINTVL or bayesian_sh1_1_5_d[q] > CONFINTVL or bayesian_sh1_2_5_d[q] > CONFINTVL or bayesian_sh2_1_5_d[q] > CONFINTVL or bayesian_sh2_2_5_d[q] > CONFINTVL:
                            ...
                            if h_form_D[q] == 0 and a_form_D[q] == 0:
                                if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                    if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                        if bayesian_10_5_d[q] <= bayesian_8_5_d[q] <= bayesian_6_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF:
                                        ...
                                        if bayesian_10_5_d[q] <= bayesian_8_5_d[q] <= bayesian_6_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and BAY_DIFF <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= bayesian_12_d[q] and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                            with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                writer(w=q, A=X, B=Y, C=Z, data=file)
                        ...
                        if home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP:
                            if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                    ...
                                    if bayesian_10_5_d[q] <= bayesian_8_5_d[q] <= bayesian_6_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                        if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                            with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                writer(w=q, A=X, B=Y, C=Z, data=file)
                                ...
                                if h_form_D[q] == 0 and a_form_D[q] == 0:
                                    if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                        if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                            if bayesian_10_5_d[q] <= bayesian_8_5_d[q] <= bayesian_6_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2):
                                                if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                    with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                        writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                                        else:
                                            if bayesian_10_5_d[q] <= bayesian_8_5_d[q] <= bayesian_6_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (BAY_DIFF / 2) <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= (0.5 * bayesian_12_d[q]):
                                                with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                    writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                            ...
                            if home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP:
                                if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                    if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                        ...
                                        if bayesian_10_5_d[q] <= bayesian_8_5_d[q] <= bayesian_6_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2) and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                            if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                    writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
