...
from _CONTROL_CENTER import set_date_s_size, game_criteria, master_sport_list1, combinatorials
...
OUTCOMES = ["HW", "AW", "ETov26.5", "ETov33.5", "ETov40.5", "ETov46.5", "ETov56.5", "ETov66.5",  "ETov86.5", "ETov106.5",
            "GTov146.5", "GTov166.5",  "GTov186.5", "GTov201.5" "GTov212.5", "GTov226.5", "12"]

start_time = time.time()
SPORT_ = master_sport_list1()[0]
...
def h2h_aggregator(m, home_score, away_score, home_x, away_x):
    ...
    if (int(home_score[m].text) + int(away_score[m].text)) >= 202:
        count_gtov_201_5 += 1
    if (int(home_score[m].text) + int(away_score[m].text)) >= 212:
        count_gtov_212_5 += 1
...
def h2h_prob_calc():
    ...
    global count_2_5
    global count_12
    prob_gtov_186_51 = float(count_gtov_186_5 / valid_games)
    ...
    if prob_AW == 1.0:
        prob_AW -= 0.01
    if prob_gtov_186_51 == 1.0:
        prob_gtov_186_51 -= 0.01
    ...
    if prob_gtov_186_51 == 0.0:
        prob_gtov_186_51 += 0.01
    if prob_gtov_201_5i == 0.0:
        prob_gtov_201_5i += 0.01
    if prob_gtov_212_5i == 0.0:
        prob_gtov_212_5i += 0.01
    if prob_gtov_226_5i == 0.0:
        prob_gtov_226_5i += 0.01
    if prob_12i == 0.0:
        prob_12i += 0.01
    if prob_HW == 0.0:
    ...
    if prob_AW == 0.0:
        prob_AW += 0.01
    return [prob_HW, prob_AW, prob_gtov_186_51, prob_gtov_201_5i, prob_gtov_212_5i, prob_gtov_226_5i, prob_12i]


def h2h_appender(prb_HW, prb_AW, prb_gtov_186_5, prb_gtov_201_5, prb_gtov_212_5, prb_gtov_226_5, prb_12):
...
def ht_indp_aggregator(k, home_score, away_score, home_x, away_x):
    ...
    if (int(home_score[k].text) + int(away_score[k].text)) >= 4 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 3:
        count_gtov_201_5_H_indp += 1
    if (int(home_score[k].text) + int(away_score[k].text)) >= 5 and (home_x[k].text == home_teamx) and int(home_score[k].text) >= 4:
        count_gtov_212_5_H_indp += 1
    if (int(home_score[k].text) + int(away_score[k].text)) >= 5 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 4:
        count_gtov_212_5_H_indp += 1
    if (int(home_score[k].text) + int(away_score[k].text)) >= 6 and (home_x[k].text == home_teamx) and int(home_score[k].text) >= 5:
        count_gtov_226_5_H_indp += 1
    if (int(home_score[k].text) + int(away_score[k].text)) >= 6 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 5:
        count_gtov_226_5_H_indp += 1
...
def ht_indp_prob_calc():
    ...
    if prob_gtov_186_5_H_indp == 0.0:
        prob_gtov_186_5_H_indp += 0.01
    if prob_gtov_201_5_H_indp == 0.0:
        prob_gtov_201_5_H_indp += 0.01
    if prob_gtov_212_5_H_indp == 0.0:
        prob_gtov_212_5_H_indp += 0.01
    if prob_gtov_226_5_H_indp == 0.0:
        prob_gtov_226_5_H_indp += 0.01
    ...
    if prob_AW_H_indp == 0.0:
        prob_AW_H_indp += 0.01
    return [prob_HW_H_indp, prob_AW_H_indp, prob_gtov_186_5_H_indp, prob_gtov_201_5_H_indp, prob_gtov_212_5_H_indp, prob_gtov_226_5_H_indp, prob_12_H_indp]


def ht_indp_appender(prb_HW_H_indp, prb_AW_H_indp, prb_gtov_186_5_H_indp, prb_gtov_201_5_H_indp, prb_gtov_212_5_H_indp, prb_gtov_226_5_H_indp, prb_12_H_indp):
...
def at_indp_aggregator(n, home_score, away_score, home_x, away_x):
    ...
    if (int(home_score[n].text) + int(away_score[n].text)) >= 4 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 3:
        count_gtov_201_5_A_indp += 1
    if (int(home_score[n].text) + int(away_score[n].text)) >= 5 and (home_x[n].text == away_teamx) and int(home_score[n].text) >= 4:
        count_gtov_212_5_A_indp += 1
    if (int(home_score[n].text) + int(away_score[n].text)) >= 5 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 4:
        count_gtov_212_5_A_indp += 1
    if (int(home_score[n].text) + int(away_score[n].text)) >= 6 and (home_x[n].text == away_teamx) and int(home_score[n].text) >= 5:
        count_gtov_226_5_A_indp += 1
    if (int(home_score[n].text) + int(away_score[n].text)) >= 6 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 5:
        count_gtov_226_5_A_indp += 1
...
def at_indp_prob_calc():
    ...
    if prob_gtov_186_5_A_indp == 0.0:
        prob_gtov_186_5_A_indp += 0.01
    if prob_gtov_201_5_A_indp == 0.0:
        prob_gtov_201_5_A_indp += 0.01
    if prob_gtov_212_5_A_indp == 0.0:
        prob_gtov_212_5_A_indp += 0.01
    if prob_gtov_226_5_A_indp == 0.0:
        prob_gtov_226_5_A_indp += 0.01
    ...
    if prob_AW_A_indp == 0.0:
        prob_AW_A_indp += 0.01
    return [prob_HW_A_indp, prob_AW_A_indp, prob_gtov_186_5_A_indp, prob_gtov_201_5_A_indp, prob_gtov_212_5_A_indp, prob_gtov_226_5_A_indp, prob_12_A_indp]


def at_indp_appender(prb_HW_A_indp, prb_AW_A_indp, prb_gtov_186_5_A_indp, prb_gtov_201_5_A_indp, prb_gtov_212_5_A_indp, prb_gtov_226_5_A_indp, prb_12_A_indp):
    ...
    try:
        ...
        try:
            try:
                ...
                pass
            OVER_gtov_186_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
            OVER_gtov_186_5_S.append(1 / float(OVER_gtov_186_5))
        except NoSuchElementException:
            try:
                OVER_gtov_186_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .ui-table__row:nth-child(4) .oddsCell__odd')[0].text.strip()
                OVER_gtov_186_5_S.append(1 / float(OVER_gtov_186_5))
            except NoSuchElementException:
        ...
        try:
            ...
            for x in range(1, 7, 1):
                try:
                    id_gtov_201_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_gtov_201_5 == "3.5":
                        OVER_gtov_201_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
            ...
            for z in range(1, 7, 1):
                try:
                    id_gtov_212_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({z}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_gtov_212_5 == "4.5":
                        OVER_gtov_212_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({z}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
            ...
            for y in range(1, 10, 1):
                try:
                    id_gtov_226_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({y}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_gtov_226_5 == "5.5":
                        OVER_gtov_226_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({y}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
...
def writer(w, A, B, C, data):
    data.write(f"{countries[w]}|{leagues[w]}|{home_teams[w]}|{away_teams[w]}|{home_positions[w]}|"
               ...
               f"{OUTCOMES[0]}:-{bayesian_home_Win_d[w]}|{OUTCOMES[1]}:-{bayesian_away_Win_d[w]}|{OUTCOMES[2]}:-{bayesian_gtov_186_5_d[w]}|{OUTCOMES[3]}:-{bayesian_gtov_201_5_d[w]}|"
               f"{OUTCOMES[4]}:-{bayesian_gtov_212_5_d[w]}|{OUTCOMES[5]}:-{bayesian_gtov_226_5_d[w]}|{OUTCOMES[6]}:-{bayesian_12_d[w]}|"
...
def writer1(y, F, G, H, J, data):
    data.write(f"{countries[y]}|{leagues[y]}|{home_teams[y]}|{away_teams[y]}|{home_positions[y]}|"
               ...
               f"{OUTCOMES[0]}:-{bayesian_home_Win_d[y]}|{OUTCOMES[1]}:-{bayesian_away_Win_d[y]}|{OUTCOMES[2]}:-{bayesian_gtov_186_5_d[y]}|{OUTCOMES[3]}:-{bayesian_gtov_201_5_d[y]}|"
               f"{OUTCOMES[4]}:-{bayesian_gtov_212_5_d[y]}|{OUTCOMES[5]}:-{bayesian_gtov_226_5_d[y]}|"
               f"{OUTCOMES[6]}:-{bayesian_12_d[y]}|{match_times[y]}|{sport}|{J}_{F}_{G}_{H}|{set_date_s_size()[0]}\n")
...
def writer2(z, K, L, M, N, P, data):
    data.write(f"{countries[z]}|{leagues[z]}|{home_teams[z]}|{away_teams[z]}|{home_positions[z]}|"
               ...
               f"{OUTCOMES[0]}:-{bayesian_home_Win_d[z]}|{OUTCOMES[1]}:-{bayesian_away_Win_d[z]}|{OUTCOMES[2]}:-{bayesian_gtov_186_5_d[z]}|{OUTCOMES[3]}:-{bayesian_gtov_201_5_d[z]}|"
               f"{OUTCOMES[4]}:-{bayesian_gtov_212_5_d[z]}|{OUTCOMES[5]}:-{bayesian_gtov_226_5_d[z]}|"
               f"{OUTCOMES[6]}:-{bayesian_12_d[z]}|{match_times[z]}|{sport}|{P}_{K}_{L}_{M}_{N}|{set_date_s_size()[0]}\n")


def baye_appender(baye_HW, baye_AW, baye_gtov_186_5, baye_gtov_201_5, baye_gtov_212_5, baye_gtov_226_5, baye_12):
...
def total_aggregator():
    ...
    try:
        ...
        if len(sub1) == 0:
            ht_indp_appender(prb_HW_H_indp=0.01, prb_AW_H_indp=0.01, prb_gtov_186_5_H_indp=0.01, prb_gtov_201_5_H_indp=0.01, prb_gtov_212_5_H_indp=0.01, prb_gtov_226_5_H_indp=0.01, prb_12_H_indp=0.01)
        else:
            dsc = 0
            for a in range(FORM_COUNT):
            ...
            if dsc >= FORM_COUNT:
                try:
                    ...
                    ht_indp_appender(prb_HW_H_indp=ht_indp_values[0], prb_AW_H_indp=ht_indp_values[1], prb_gtov_186_5_H_indp=ht_indp_values[2], prb_gtov_201_5_H_indp=ht_indp_values[3],
                                     prb_gtov_212_5_H_indp=ht_indp_values[4], prb_gtov_226_5_H_indp=ht_indp_values[5], prb_12_H_indp=ht_indp_values[6])
                except ZeroDivisionError:
                    ht_indp_appender(prb_HW_H_indp=0.01, prb_AW_H_indp=0.01, prb_gtov_186_5_H_indp=0.01, prb_gtov_201_5_H_indp=0.01, prb_gtov_212_5_H_indp=0.01, prb_gtov_226_5_H_indp=0.01, prb_12_H_indp=0.01)
            else:
                ht_indp_appender(prb_HW_H_indp=0.01, prb_AW_H_indp=0.01, prb_gtov_186_5_H_indp=0.01, prb_gtov_201_5_H_indp=0.01, prb_gtov_212_5_H_indp=0.01, prb_gtov_226_5_H_indp=0.01, prb_12_H_indp=0.01)
    ...
    try:
        ...
        if len(sub2) == 0:
            at_indp_appender(prb_HW_A_indp=0.01, prb_AW_A_indp=0.01, prb_gtov_186_5_A_indp=0.01, prb_gtov_201_5_A_indp=0.01, prb_gtov_212_5_A_indp=0.01, prb_gtov_226_5_A_indp=0.01, prb_12_A_indp=0.01)
        else:
            dsc = 0
            for b in range(FORM_COUNT):
            ...
            if dsc >= FORM_COUNT:
                try:
                    ...
                    at_indp_appender(prb_HW_A_indp=at_indp_values[0], prb_AW_A_indp=at_indp_values[1], prb_gtov_186_5_A_indp=at_indp_values[2], prb_gtov_201_5_A_indp=at_indp_values[3],
                                     prb_gtov_212_5_A_indp=at_indp_values[4], prb_gtov_226_5_A_indp=at_indp_values[5], prb_12_A_indp=at_indp_values[6])
                except ZeroDivisionError:
                    at_indp_appender(prb_HW_A_indp=0.01, prb_AW_A_indp=0.01, prb_gtov_186_5_A_indp=0.01, prb_gtov_201_5_A_indp=0.01, prb_gtov_212_5_A_indp=0.01, prb_gtov_226_5_A_indp=0.01, prb_12_A_indp=0.01)
            else:
                at_indp_appender(prb_HW_A_indp=0.01, prb_AW_A_indp=0.01, prb_gtov_186_5_A_indp=0.01, prb_gtov_201_5_A_indp=0.01, prb_gtov_212_5_A_indp=0.01, prb_gtov_226_5_A_indp=0.01, prb_12_A_indp=0.01)
    ...
    try:
        ...
        if len(sub3) == 0:
            h2h_appender(prb_HW=0.01, prb_AW=0.1, prb_gtov_186_5=0.01, prb_gtov_201_5=0.01, prb_gtov_212_5=0.01, prb_gtov_226_5=0.01, prb_12=0.01)
        else:
            dsc = 0
            ...
            if dsc >= DSCRM_BT:
                try:
                    ...
                    h2h_appender(prb_HW=h2h_values[0], prb_AW=h2h_values[1], prb_gtov_186_5=h2h_values[2],  prb_gtov_201_5=h2h_values[3],
                                 prb_gtov_212_5=h2h_values[4], prb_gtov_226_5=h2h_values[5], prb_12=h2h_values[6])
                except ZeroDivisionError:
                    h2h_appender(prb_HW=0.01, prb_AW=0.1, prb_gtov_186_5=0.01, prb_gtov_201_5=0.01, prb_gtov_212_5=0.01, prb_gtov_226_5=0.01, prb_12=0.01)
            else:
                h2h_appender(prb_HW=0.01, prb_AW=0.1, prb_gtov_186_5=0.01, prb_gtov_201_5=0.01, prb_gtov_212_5=0.01, prb_gtov_226_5=0.01, prb_12=0.01)
...
def print_all_data():
    ...
    print(f"Prob GGs: {prob_gtov_186_5s}")
    print(f"Prob 3_5s: {prob_gtov_201_5s}")
    print(f"Prob 4_5s: {prob_gtov_212_5s}")
    print(f"Prob 5_5s: {prob_gtov_226_5s}")
    print(f"Prob 12s: {prob_12s}")
    print(f"Prob HWs: {prob_HWs}")
    print(f"Prob AWs: {prob_AWs}")
    print(f"Prob GG_H_indps: {prob_gtov_186_5_H_indps}")
    print(f"Prob 3_5_H_indps: {prob_gtov_201_5_H_indps}")
    print(f"Prob 4_5_H_indps: {prob_gtov_212_5_H_indps}")
    print(f"Prob 5_5_H_indps: {prob_gtov_226_5_H_indps}")
    print(f"Prob 12_H_indps: {prob_12_H_indps}")
    print(f"Prob HW_H_indps: {prob_HW_H_indps}")
    print(f"Prob AW_H_indps: {prob_AW_H_indps}")
    print(f"Prob GG_A_indps: {prob_gtov_186_5_A_indps}")
    print(f"Prob 3_5_A_indps: {prob_gtov_201_5_A_indps}")
    print(f"Prob 4_5_A_indps: {prob_gtov_212_5_A_indps}")
    print(f"Prob 5_5_A_indps: {prob_gtov_226_5_A_indps}")
    ...
    print(f"Bayesian GG: {bayesian_gtov_186_5_d}")
    print(f"Bayesian 3.5: {bayesian_gtov_201_5_d}")
    print(f"Bayesian 4.5: {bayesian_gtov_212_5_d}")
    print(f"Bayesian 5.5: {bayesian_gtov_226_5_d}")
    ...
    print(f"Countries: {len(countries)}, Leagues: {len(leagues)}, Home Teams: {len(home_teams)}, "
          ...
          f"Prob GGs: {len(prob_gtov_186_5s)}, Prob 3_5s: {len(prob_gtov_201_5s)} Prob 4_5s: {len(prob_gtov_212_5s)}, Prob 5_5s: {len(prob_gtov_226_5s)},"
          f"Prob 12s: {len(prob_12s)}, Prob HWs: {len(prob_HWs)}, Prob AWs: {len(prob_AWs)}, "
          f"Prob GG_H_indps: {len(prob_gtov_186_5_H_indps)}, Prob 3_5_H_indps: {len(prob_gtov_201_5_H_indps)}, Prob 4_5_H_indps: {len(prob_gtov_212_5_H_indps)}, "
          f"Prob 5_5_H_indps: {len(prob_gtov_226_5_H_indps)}, Prob 12_H_indps: {len(prob_12_H_indps)},"
          f"Prob HW_H_indps: {len(prob_HW_H_indps)}, Prob AW_H_indps: {len(prob_AW_H_indps)}, "
          f"Prob GG_A_indps: {len(prob_gtov_186_5_A_indps)}, Prob 3_5_A_indps: {len(prob_gtov_201_5_A_indps)}, Prob 4_5_A_indps: {len(prob_gtov_212_5_A_indps)}, "
          f"Prob 5_5_A_indps: {len(prob_gtov_226_5_A_indps)}, Prob 12_A_indps: {len(prob_12_A_indps)}, "
          f"Prob HW_A_indps: {len(prob_HW_A_indps)}, Prob AW_A_indps: {len(prob_AW_A_indps)}, "
          f"Odds _1HWS: {len(_1HWS)}, Odds _2AWS: {len(_2AWS)}, Odds OVER_gtov_186_5_S: {OVER_gtov_186_5_S}, Odds OVER_gtov_201_5_S: {len(OVER_gtov_201_5_S)}, "
          f"Odds OVER_gtov_212_5_S: {len(OVER_gtov_212_5_S)}, Odds OVER_gtov_226_5_S: {len(OVER_gtov_226_5_S)}, Odds _12S: {len(_12S)}"
          f"Bayesian Home Win: {len(bayesian_home_Win_d)}, Bayesian Away Win: {len(bayesian_away_Win_d)}, "
          f"Bayesian GG: {len(bayesian_gtov_186_5_d)}, Bayesian 3.5: {len(bayesian_gtov_201_5_d)}, Bayesian 4.5: {len(bayesian_gtov_212_5_d)}, "
          f"Bayesian 5.5: {len(bayesian_gtov_226_5_d)}, Bayesian 12: {len(bayesian_12_d) }")
            ...
            for q in range(len(home_teams)):
                try:
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[0]:
                        ...
                        baye_appender(baye_HW=bayesian_home_Win, baye_AW=bayesian_away_Win, baye_gtov_186_5=bayesian_gtov_186_5, baye_gtov_201_5=bayesian_gtov_201_5, baye_gtov_212_5=bayesian_gtov_212_5, baye_gtov_226_5=bayesian_gtov_226_5, baye_12=bayesian_12)
                    ...
                    for i in range(11):
                        with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_{i}.txt", mode="a") as file:
                            file.write(f"CONFIDENCE INTERVAL - {CONFINTVL}~COUNTRIES|LEAGUES|HOME TEAMS|AWAY TEAMS|HOME POSITIONS|AWAY POSITIONS|HOME NMP|AWAY NMP|"
                                       ...
                                       f"BAYESIAN {OUTCOMES[5]}|BAYESIAN {OUTCOMES[6]}|MATCH TIME|SPORT|DIRECTORY|MATCH DATE\n")
                try:
                    if bayesian_home_Win_d[q] > CONFINTVL or bayesian_away_Win_d[q] > CONFINTVL or bayesian_gtov_186_5_d[q] > CONFINTVL or bayesian_gtov_201_5_d[q] > CONFINTVL or bayesian_gtov_212_5_d[q] > CONFINTVL or bayesian_gtov_226_5_d[q] > CONFINTVL or bayesian_12_d[q] > CONFINTVL:
                        if home_nums_matches_played[q] >= NMP or away_nums_matches_played[q] >= NMP:
                            if h_form_D[q] == 0 and a_form_D[q] == 0:
                                if (h_form_W[q] >= FORM_VALUE and a_form_W[q] <= (1 - FORM_VALUE)) or (a_form_W[q] >= FORM_VALUE and h_form_W[q] <= (1 - FORM_VALUE)):
                                    if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                        if bayesian_gtov_226_5_d[q] <= bayesian_gtov_212_5_d[q] <= bayesian_gtov_201_5_d[q] <= bayesian_gtov_186_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF:
                                        ...
                                        if bayesian_gtov_226_5_d[q] <= bayesian_gtov_212_5_d[q] <= bayesian_gtov_201_5_d[q] <= bayesian_gtov_186_5_d[q] and BAY_DIFF <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= bayesian_12_d[q]:
                                            with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                writer(w=q, A=X, B=Y, C=Z, data=file)
                        ...
                        if home_nums_matches_played[q] >= NMP or away_nums_matches_played[q] >= NMP:
                            if (h_form_W[q] >= FORM_VALUE and a_form_W[q] <= (1 - FORM_VALUE)) or (a_form_W[q] >= FORM_VALUE and h_form_W[q] <= (1 - FORM_VALUE)):
                                if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                    ...
                                    if bayesian_gtov_226_5_d[q] <= bayesian_gtov_212_5_d[q] <= bayesian_gtov_201_5_d[q] <= bayesian_gtov_186_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                        if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]):
                                            with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                writer(w=q, A=X, B=Y, C=Z, data=file)
                                ...
                                if h_form_D[q] == 0 and a_form_D[q] == 0:
                                    if (h_form_W[q] >= FORM_VALUE and a_form_W[q] <= (1 - FORM_VALUE)) or (a_form_W[q] >= FORM_VALUE and h_form_W[q] <= (1 - FORM_VALUE)):
                                        if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                            if bayesian_gtov_226_5_d[q] <= bayesian_gtov_212_5_d[q] <= bayesian_gtov_201_5_d[q] <= bayesian_gtov_186_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2):
                                                if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]):
                                                    with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                        writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                                        else:
                                            if bayesian_gtov_226_5_d[q] <= bayesian_gtov_212_5_d[q] <= bayesian_gtov_201_5_d[q] <= bayesian_gtov_186_5_d[q] and (BAY_DIFF / 2) <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= (0.5 * bayesian_12_d[q]):
                                                with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                    writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                            ...
                            if home_nums_matches_played[q] >= NMP or away_nums_matches_played[q] >= NMP:
                                if (h_form_W[q] >= FORM_VALUE and a_form_W[q] <= (1 - FORM_VALUE)) or (a_form_W[q] >= FORM_VALUE and h_form_W[q] <= (1 - FORM_VALUE)):
                                    if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                        ...
                                        if bayesian_gtov_226_5_d[q] <= bayesian_gtov_212_5_d[q] <= bayesian_gtov_201_5_d[q] <= bayesian_gtov_186_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2) and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                            if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]):
                                                with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                    writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
...
if is_running(game_criteria()[12][1]) is False and is_running(game_criteria()[12][2]) is False and is_running(game_criteria()[12][3]) is False:
    try:
        cleanse()
