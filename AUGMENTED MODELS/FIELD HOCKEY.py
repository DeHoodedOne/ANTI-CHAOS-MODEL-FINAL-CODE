...
OUTCOMES = ["HW", "AW", "ov3.5", "ov4.5", "ov5.5", "sh1_1.5", "sh1_2.5", "sh2_1.5", "sh2_2.5", "12"]

start_time = time.time()
SPORT_ = master_sport_list()[0][12]
...
def h2h_prob_calc():
    ...
    prob_4_5i = float(count_4_5 / valid_games)
    prob_5_5i = float(count_5_5 / valid_games)
    ...
    if prob_AW == 0:
        prob_AW += 0.01
    return [prob_HW, prob_AW, prob_3_5i, prob_4_5i, prob_5_5i, prob_sh1_1_5i, prob_sh1_2_5i, prob_sh2_1_5i, prob_sh2_2_5i, prob_12i]


def h2h_appender(prb_HW, prb_AW, prb_3_5, prb_4_5, prb_5_5, prb_sh1_1_5, prb_sh1_2_5, prb_sh2_1_5, prb_sh2_2_5, prb_12):
...
def ht_indp_aggregator(k, home_score, away_score, home_x, away_x):
    ...
    global count_4_5_H_indp
    global count_5_5_H_indp
    ...
    if int(home_score[k].text) == int(away_score[k].text) and (int(home_score[k].text) == 0 and int(away_score[k].text) == 0):
        count_HW_H_indp += 0
    if (int(home_score[k].text) + int(away_score[k].text)) >= 4 and (home_x[k].text == home_teamx) and int(home_score[k].text) >= 4:
        count_3_5_H_indp += 1
    if (int(home_score[k].text) + int(away_score[k].text)) >= 4 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 4:
        count_3_5_H_indp += 1
    if (int(home_score[k].text) + int(away_score[k].text)) >= 5 and (home_x[k].text == home_teamx) and int(home_score[k].text) >= 5:
        count_4_5_H_indp += 1
    if (int(home_score[k].text) + int(away_score[k].text)) >= 5 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 5:
        count_4_5_H_indp += 1
    if (int(home_score[k].text) + int(away_score[k].text)) >= 6 and (home_x[k].text == home_teamx) and int(home_score[k].text) >= 6:
        count_5_5_H_indp += 1
    if (int(home_score[k].text) + int(away_score[k].text)) >= 6 and (away_x[k].text == home_teamx) and int(away_score[k].text) >= 6:
        count_5_5_H_indp += 1
...
def ht_indp_prob_calc():
    ...
    prob_4_5_H_indp = float(count_4_5_H_indp / valid_games_H_indp)
    prob_5_5_H_indp = float(count_5_5_H_indp / valid_games_H_indp)
    ...
    if prob_4_5_H_indp == 1.0:
        prob_4_5_H_indp -= 0.01
    if prob_5_5_H_indp == 1.0:
        prob_5_5_H_indp -= 0.01
    ...
    if prob_3_5_H_indp == 0:
        prob_3_5_H_indp += 0.01
    if prob_4_5_H_indp == 0:
        prob_4_5_H_indp += 0.01
    if prob_5_5_H_indp == 0:
        prob_5_5_H_indp += 0.01
    ...
    if prob_AW_H_indp == 0:
        prob_AW_H_indp += 0.01
    return [prob_HW_H_indp, prob_AW_H_indp, prob_3_5_H_indp, prob_4_5_H_indp, prob_5_5_H_indp, prob_sh1_1_5_H_indp,
            prob_sh1_2_5_H_indp, prob_sh2_1_5_H_indp, prob_sh2_2_5_H_indp, prob_12_H_indp]


def ht_indp_appender(prb_HW_H_indp, prb_AW_H_indp, prb_3_5_H_indp, prb_4_5_H_indp, prb_5_5_H_indp, prb_sh1_1_5_H_indp,
...
def at_indp_aggregator(n, home_score, away_score, home_x, away_x):
    ...
    global count_4_5_A_indp
    global count_5_5_A_indp
    ...
    if int(home_score[n].text) == int(away_score[n].text) and (int(home_score[n].text) == 0 and int(away_score[n].text) == 0):
        count_AW_A_indp += 0
    if (int(home_score[n].text) + int(away_score[n].text)) >= 4 and (home_x[n].text == away_teamx) and int(home_score[n].text) >= 4:
        count_3_5_A_indp += 1
    if (int(home_score[n].text) + int(away_score[n].text)) >= 4 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 4:
        count_3_5_A_indp += 1
    if (int(home_score[n].text) + int(away_score[n].text)) >= 5 and (home_x[n].text == away_teamx) and int(home_score[n].text) >= 5:
        count_4_5_A_indp += 1
    if (int(home_score[n].text) + int(away_score[n].text)) >= 5 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 5:
        count_4_5_A_indp += 1
    if (int(home_score[n].text) + int(away_score[n].text)) >= 6 and (home_x[n].text == away_teamx) and int(home_score[n].text) >= 6:
        count_5_5_A_indp += 1
    if (int(home_score[n].text) + int(away_score[n].text)) >= 6 and (away_x[n].text == away_teamx) and int(away_score[n].text) >= 6:
        count_5_5_A_indp += 1
...
def at_indp_prob_calc():
    ...
    prob_4_5_A_indp = float(count_4_5_A_indp / valid_games_A_indp)
    prob_5_5_A_indp = float(count_5_5_A_indp / valid_games_A_indp)
    ...
    if prob_4_5_A_indp == 1.0:
        prob_4_5_A_indp -= 0.01
    if prob_5_5_A_indp == 1.0:
        prob_5_5_A_indp -= 0.01
    ...
    if prob_3_5_A_indp == 0:
        prob_3_5_A_indp += 0.01
    if prob_4_5_A_indp == 0:
        prob_4_5_A_indp += 0.01
    if prob_5_5_A_indp == 0:
        prob_5_5_A_indp += 0.01
    ...
    if prob_AW_A_indp == 0:
        prob_AW_A_indp += 0.01
    return [prob_HW_A_indp, prob_AW_A_indp, prob_3_5_A_indp, prob_4_5_A_indp, prob_5_5_A_indp, prob_sh1_1_5_A_indp,
            prob_sh1_2_5_A_indp, prob_sh2_1_5_A_indp, prob_sh2_2_5_A_indp, prob_12_A_indp]


def at_indp_appender(prb_HW_A_indp, prb_AW_A_indp, prb_3_5_A_indp, prb_4_5_A_indp, prb_5_5_A_indp, prb_sh1_1_5_A_indp,
    ...
    try:
        ...
        try:
            ...
            for y in range(len(ahl)):
                try:
                    ...
                    OVER_sh1_2_5_S.append(0.5)
                    OVER_sh2_2_5_S.append(0.5)
        except (NoSuchElementException, IndexError, StaleElementReferenceException, ElementClickInterceptedException, ElementNotInteractableException):
            OVER_sh1_1_5_S.append(0.5)
            OVER_sh1_2_5_S.append(0.5)
            OVER_sh2_1_5_S.append(0.5)
            OVER_sh2_2_5_S.append(0.5)
        ...
        try:
            ...
            for x in range(len(ahl)):
                try:
                    id_3_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_3_5 == "3.5":
                        OVER_3_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
            ...
            for x in range(len(ahl)):
                try:
                    id_4_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_4_5 == "4.5":
                        OVER_4_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({x}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
                        OVER_4_5_S.append(1 / float(OVER_4_5))
                        break
                    if x == (len(ahl) - 1):
                        OVER_4_5_S.append(0.5)
                except NoSuchElementException:
                    continue
                except IndexError:
                    OVER_4_5_S.append(0.5)
            for z in range(len(ahl)):
                try:
                    id_5_5 = driver.find_element(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({z}) .ui-table__row:nth-child(1) .oddsCell__noOddsCell').text
                    if id_5_5 == "5.5":
                        OVER_5_5 = driver.find_elements(By.CSS_SELECTOR, f'.oddsTab__tableWrapper .oddsCell__odds:nth-child({z}) .ui-table__row:nth-child(1) .oddsCell__odd')[0].text.strip()
                        OVER_5_5_S.append(1 / float(OVER_5_5))
                        break
                    if z == (len(ahl) - 1):
                        OVER_5_5_S.append(0.5)
                except NoSuchElementException:
                    continue
                except IndexError:
                    OVER_5_5_S.append(0.5)
...
def writer(w, A, B, C, data):
    data.write(f"{countries[w]}|{leagues[w]}|{home_teams[w]}|{away_teams[w]}|{home_positions[w]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_3_5_d[w]}|{OUTCOMES[3]}:-{bayesian_4_5_d[w]}|"
               f"{OUTCOMES[4]}:-{bayesian_5_5_d[w]}|{OUTCOMES[5]}:-{bayesian_sh1_1_5_d[w]}|{OUTCOMES[6]}:-{bayesian_sh1_2_5_d[w]}|"
...
def writer1(y, F, G, H, J, data):
    data.write(f"{countries[y]}|{leagues[y]}|{home_teams[y]}|{away_teams[y]}|{home_positions[y]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_3_5_d[y]}|{OUTCOMES[3]}:-{bayesian_4_5_d[y]}|"
               f"{OUTCOMES[4]}:-{bayesian_5_5_d[y]}|{OUTCOMES[5]}:-{bayesian_sh1_1_5_d[y]}|{OUTCOMES[6]}:-{bayesian_sh1_2_5_d[y]}|"
...
def writer2(z, K, L, M, N, P, data):
    data.write(f"{countries[z]}|{leagues[z]}|{home_teams[z]}|{away_teams[z]}|{home_positions[z]}|"
               ...
               f"{OUTCOMES[2]}:-{bayesian_3_5_d[z]}|{OUTCOMES[3]}:-{bayesian_4_5_d[z]}|"
               f"{OUTCOMES[4]}:-{bayesian_5_5_d[z]}|{OUTCOMES[5]}:-{bayesian_sh1_1_5_d[z]}|{OUTCOMES[6]}:-{bayesian_sh1_2_5_d[z]}|"
...
def baye_appender(baye_HW, baye_AW, baye_3_5, baye_4_5, baye_5_5, baye_sh1_1_5, baye_sh1_2_5, baye_sh2_1_5,
...
def total_aggregator():
    ...
    try:
        ...
        if len(sub1) == 0:
            ht_indp_appender(prb_HW_H_indp=0.01, prb_AW_H_indp=0.01, prb_3_5_H_indp=0.01, prb_4_5_H_indp=0.01,
                             prb_5_5_H_indp=0.01, prb_sh1_1_5_H_indp=0.01, prb_sh1_2_5_H_indp=0.01,
            ...
            if dsc >= DSCRM_H_A:
                try:
                    ...
                    ht_indp_appender(prb_HW_H_indp=ht_indp_values[0], prb_AW_H_indp=ht_indp_values[1],
                                     prb_3_5_H_indp=ht_indp_values[2], prb_4_5_H_indp=ht_indp_values[3],
                                     prb_5_5_H_indp=ht_indp_values[4], prb_sh1_1_5_H_indp=ht_indp_values[5],
    ...
    try:
        ...
        if len(sub2) == 0:
            at_indp_appender(prb_HW_A_indp=0.01, prb_AW_A_indp=0.01, prb_3_5_A_indp=0.01, prb_4_5_A_indp=0.01,
                             prb_5_5_A_indp=0.01, prb_sh1_1_5_A_indp=0.01, prb_sh1_2_5_A_indp=0.01,
            ...
            if dsc >= DSCRM_H_A:
                try:
                    ...
                    at_indp_appender(prb_HW_A_indp=at_indp_values[0], prb_AW_A_indp=at_indp_values[1],
                                     prb_3_5_A_indp=at_indp_values[2], prb_4_5_A_indp=at_indp_values[3],
                                     prb_5_5_A_indp=at_indp_values[4], prb_sh1_1_5_A_indp=at_indp_values[5],
    ...
    try:
        ...
        if len(sub3) == 0:
            h2h_appender(prb_HW=0.01, prb_AW=0.01, prb_3_5=0.01, prb_4_5=0.01, prb_5_5=0.01, prb_sh1_1_5=0.01,
            ...
            if dsc >= DSCRM_BT:
                try:
                    ...
                    h2h_appender(prb_HW=h2h_values[0], prb_AW=h2h_values[1], prb_3_5=h2h_values[2], prb_4_5=h2h_values[3],
                                 prb_5_5=h2h_values[4], prb_sh1_1_5=h2h_values[5], prb_sh1_2_5=h2h_values[6],
...
def print_all_data():
    ...
    print(f"Prob 8_5s: {prob_3_5s}")
    print(f"Prob 9_5s: {prob_4_5s}")
    print(f"Prob 10_5s: {prob_5_5s}")
    print(f"Prob sh1_1_4_5s: {prob_sh1_1_5s}")
    print(f"Prob sh1_2_4_5s: {prob_sh1_2_5s}")
    print(f"Prob sh2_1_4_5s: {prob_sh2_1_5s}")
    print(f"Prob sh2_2_4_5s: {prob_sh2_2_5s}")
    print(f"Prob 12s: {prob_12s}")
    print(f"Prob HWs: {prob_HWs}")
    print(f"Prob AWs: {prob_AWs}")
    print(f"Prob 8_5_H_indps: {prob_3_5_H_indps}")
    print(f"Prob 9_5_H_indps: {prob_4_5_H_indps}")
    print(f"Prob 10_5_H_indps: {prob_5_5_H_indps}")
    ...
    print(f"Prob 8_5_A_indps: {prob_3_5_A_indps}")
    print(f"Prob 9_5_A_indps: {prob_4_5_A_indps}")
    print(f"Prob 10_5_A_indps: {prob_5_5_A_indps}")
    ...
    print(f"Bayesian 8.5: {bayesian_3_5_d}")
    print(f"Bayesian 9.5: {bayesian_4_5_d}")
    print(f"Bayesian 10.5: {bayesian_5_5_d}")
    ...
    print(f"Odds OVER_4_5_S: {OVER_4_5_S}")
    print(f"Odds OVER_5_5_S: {OVER_5_5_S}")
    ...
    print(f"Countries: {len(countries)}, Leagues: {len(leagues)}, Home Teams: {len(home_teams)}, "
          ...
          f"Prob 8_5s: {len(prob_3_5s)}, Prob 9_5s: {len(prob_4_5s)} Prob 10_5s: {len(prob_5_5s)}, Prob 9_5s: {len(prob_sh1_1_5s)},"
          f"Prob 12s: {len(prob_12s)}, Prob HWs: {len(prob_HWs)}, Prob AWs: {len(prob_AWs)}, "
          f"Prob 8_5_H_indps: {len(prob_3_5_H_indps)}, Prob 9_5_H_indps: {len(prob_4_5_H_indps)}, Prob 10_5_H_indps: {len(prob_5_5_H_indps)}, "
          ...
          f"Prob 8_5_A_indps: {len(prob_3_5_A_indps)}, Prob 9_5_A_indps: {len(prob_4_5_A_indps)}, Prob 10_5_A_indps: {len(prob_5_5_A_indps)}, "
          ...
          f"Odds _1HWS: {len(_1HWS)}, Odds _2AWS: {len(_2AWS)}, Odds OVER_3_5_S: {len(OVER_4_5_S)},  Odds OVER_4_5_S: {len(OVER_4_5_S)}, "
          f"Odds OVER_5_5_S: {len(OVER_5_5_S)}, Odds OVER_sh1_1_5_S: {len(OVER_sh1_1_5_S)}, Odds _12S: {len(_12S)}"
          f"Bayesian Home Win: {len(bayesian_home_Win_d)}, Bayesian Away Win: {len(bayesian_away_Win_d)}, "
          f"Bayesian 8_5: {len(bayesian_3_5_d)}, Bayesian 5.5: {len(bayesian_4_5_d)}, Bayesian 6.5: {len(bayesian_5_5_d)}, "
    ...
    for COMBINER in COMBINERS[:4]:
        ...
        for COMB in COMB_PROB_METRICS1:
            ...
            for q in range(len(home_teams)):
                try:
                    if X == PROB_METRICS[0] and Y == PROB_METRICS[1] and Z == COMBINERS[0]:
                        ...
                        baye_appender(baye_HW=bayesian_home_Win, baye_AW=bayesian_away_Win, baye_3_5=bayesian_3_5, baye_4_5=bayesian_4_5, baye_5_5=bayesian_5_5, baye_sh1_1_5=bayesian_sh1_1_5, baye_sh1_2_5=bayesian_sh1_2_5, baye_sh2_1_5=bayesian_sh2_1_5, baye_sh2_2_5=bayesian_sh2_2_5, baye_12=bayesian_12)
            ...
            for q in range(len(bayesian_home_Win_d)):
                ...
                try:
                    if bayesian_3_5_d[q] > CONFINTVL or bayesian_4_5_d[q] > CONFINTVL or bayesian_5_5_d[q] > CONFINTVL or bayesian_sh1_1_5_d[q] > CONFINTVL or bayesian_sh1_2_5_d[q] > CONFINTVL or bayesian_sh2_1_5_d[q] > CONFINTVL or bayesian_sh2_2_5_d[q] > CONFINTVL:
                            ...
                            if h_form_D[q] == 0 and a_form_D[q] == 0:
                                if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                    if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                        if bayesian_5_5_d[q] <= bayesian_4_5_d[q] <= bayesian_3_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF:
                                        ...
                                        if bayesian_5_5_d[q] <= bayesian_4_5_d[q] <= bayesian_3_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and BAY_DIFF <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= bayesian_12_d[q] and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                            with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                writer(w=q, A=X, B=Y, C=Z, data=file)
                        ...
                        if home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP:
                            if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                if X == PROB_METRICS[1] or Y == PROB_METRICS[1]:
                                    ...
                                    if bayesian_5_5_d[q] <= bayesian_4_5_d[q] <= bayesian_3_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= BAY_DIFF and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                        if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                            with open(f"../RESULTS - {Z}_{X}_{Y}/{Z}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                writer(w=q, A=X, B=Y, C=Z, data=file)
                                ...
                                if h_form_D[q] == 0 and a_form_D[q] == 0:
                                    if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                        if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                            if bayesian_5_5_d[q] <= bayesian_4_5_d[q] <= bayesian_3_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1 and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2):
                                                if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                    with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                        writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                                        else:
                                            if bayesian_5_5_d[q] <= bayesian_4_5_d[q] <= bayesian_3_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and (BAY_DIFF / 2) <= abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) <= (0.5 * bayesian_12_d[q]):
                                                with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_0.txt", mode="a") as file:
                                                    writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
                            ...
                            if home_nums_matches_played[q] >= NMP and away_nums_matches_played[q] >= NMP:
                                if h_form_W[q] >= FORM_VALUE and a_form_W[q] >= FORM_VALUE:
                                    if W != PROB_METRICS[2] and X != PROB_METRICS[2] and Y != PROB_METRICS[2]:
                                        ...
                                        if bayesian_5_5_d[q] <= bayesian_4_5_d[q] <= bayesian_3_5_d[q] and bayesian_sh1_2_5_d[q] >= bayesian_sh1_1_5_d[q] and bayesian_sh2_2_5_d[q] >= bayesian_sh2_1_5_d[q] and abs(bayesian_home_Win_d[q] - bayesian_away_Win_d[q]) >= (BAY_DIFF / 2) and (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) <= 1:
                                            if bayesian_12_d[q] >= (bayesian_home_Win_d[q] + bayesian_away_Win_d[q]) and bayesian_12_d[q] >= CONFINTVLS[-1]:
                                                with open(f"../RESULTS - {Z}_{W}_{X}_{Y}/{Z}_{W}_{X}_{Y}_{sport}_10.txt", mode="a") as file:
                                                    writer1(y=q, F=W, G=X, H=Y, J=Z, data=file)
        ...
        with open(f"../LISTS - SPORTS DATA/SPORTS_DATA_LIST_{sport}.txt", mode="a") as file:
            try:
                file.write(f"countries = {countries}\nleagues = {leagues}\nhome_teams = {home_teams}\n"
                           ...
                           f"OVER_4_5_S = {OVER_4_5_S}\nOVER_5_5_S = {OVER_5_5_S}\n"
